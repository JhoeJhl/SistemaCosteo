...
Jr(qo, {
    ...
    NodeView: () => Xb,
    PasteRule: () => _o,
    ResizableNodeView: () => jo,
    ResizableNodeview: () => Ub,
    Tracker: () => Zb,
    callOrReturn: () => J,
    canInsertNode: () => zl,
    combineTransactionSteps: () => Ro,
    commands: () => kl,
    createAtomBlockMarkdownSpec: () => Xu,
    createBlockMarkdownSpec: () => Ht,
    createChainableState: () => Sr,
    createDocument: () => To,
    createElement: () => Wb,
    createInlineMarkdownSpec: () => Yu,
    createMappablePosition: () => Eu,
    createNodeFromContent: () => Dn,
    createStyleTag: () => Ju,
    defaultBlockAt: () => Pn,
    deleteProps: () => gl,
    elementFromString: () => Rn,
    escapeForRegEx: () => Hl,
    extensions: () => Pu,
    findChildren: () => on,
    findChildrenInRange: () => Ml,
    findDuplicates: () => ku,
    findParentNode: () => qe,
    findParentNodeClosestToPos: () => Do,
    flattenExtensions: () => Io,
    fromString: () => xu,
    generateHTML: () => lb,
    generateJSON: () => ab,
    generateText: () => cb,
    getAttributes: () => Ho,
    getAttributesFromExtensions: () => Al,
    getChangedRanges: () => $o,
    getDebugJSON: () => vu,
    getExtensionField: () => B,
    getHTMLFromFragment: () => Tr,
    getMarkAttributes: () => vl,
    getMarkRange: () => No,
    getMarkType: () => ot,
    getMarksBetween: () => Ar,
    getNodeAtPosition: () => Rl,
    getNodeAttributes: () => Su,
    getNodeType: () => re,
    getRenderedAttributes: () => kr,
    getSchema: () => Bo,
    getSchemaByResolvedExtensions: () => El,
    getSchemaTypeByName: () => Mo,
    getSchemaTypeNameByName: () => Mr,
    getSplittedAttributes: () => wr,
    getText: () => Ol,
    getTextBetween: () => Nl,
    getTextContentFromNodes: () => Mu,
    getTextSerializersFromSchema: () => zo,
    getUpdatedPosition: () => Au,
    h: () => Wb,
    injectExtensionAttributesToParseRule: () => yl,
    inputRulesPlugin: () => Ou,
    isActive: () => Fo,
    isAndroid: () => Oo,
    isAtEndOfNode: () => Dl,
    ...
    posToDOMRect: () => Ll,
    removeDuplicates: () => Cu,
    renderNestedMarkdownContent: () => Hn,
    resolveExtensions: () => Lo,
    resolveFocusPosition: () => Sl,
    rewriteUnknownContent: () => ub,
    selectionToInsertionEnd: () => bu,
    serializeAttributes: () => Ko,
    sortExtensions: () => Po,
    splitExtensions: () => rn,
    textInputRule: () => Vb,
    textPasteRule: () => Qb,
    textblockTypeInputRule: () => zn,
    updateMarkViewAttributes: () => $l,
...
function tc(t, e, n) {
    for (let r = 0; ; r++) {
        ...
        if (o.content.size || i.content.size) {
            let s = tc(o.content, i.content, n + 1);
            if (s != null) return s;
        }
        n += o.nodeSize;
    }
...
function nc(t, e, n, r) {
    for (let o = t.childCount, i = e.childCount; ; ) {
        ...
        if (s.content.size || l.content.size) {
            let c = nc(s.content, l.content, n - 1, r - 1);
            if (c) return c;
        }
        ((n -= a), (r -= a));
    }
...
var v = class t {
    ...
    findDiffEnd(e, n = this.size, r = e.size) {
        return nc(this, e, n, r);
    }
    findIndex(e) {
        if (e == 0) return Gr(0, e);
        if (e == this.size) return Gr(this.content.length, e);
        if (e > this.size || e < 0)
            throw new RangeError(`Position ${e} outside of fragment (${this})`);
        for (let n = 0, r = 0; ; n++) {
            let o = this.child(n),
                i = r + o.nodeSize;
            if (i >= e) return i == e ? Gr(n + 1, i) : Gr(n, r);
            r = i;
        }
    }
    toString() {
...
v.empty = new v([], 0);
var Qi = { index: 0, offset: 0 };
function Gr(t, e) {
    return ((Qi.index = t), (Qi.offset = e), Qi);
}
function Yr(t, e) {
    if (t === e) return !0;
    ...
    if (n) {
        ...
        for (let r = 0; r < t.length; r++) if (!Yr(t[r], e[r])) return !1;
    } else {
        for (let r in t) if (!(r in e) || !Yr(t[r], e[r])) return !1;
...
var G = class t {
    ...
    eq(e) {
        return this == e || (this.type == e.type && Yr(this.attrs, e.attrs));
    }
    toJSON() {
...
var At = class extends Error {},
    N = class t {
        ...
        insertAt(e, n) {
            let r = oc(this.content, e + this.openStart, n);
            return r && new t(r, this.openStart, this.openEnd);
        }
        removeBetween(e, n) {
            return new t(
                rc(this.content, e + this.openStart, n + this.openStart),
                this.openStart,
                this.openEnd,
            );
        }
...
function rc(t, e, n) {
    ...
    return t.replaceChild(r, i.copy(rc(i.content, e - o - 1, n - o - 1)));
}
function oc(t, e, n, r) {
...
function ic(t, e, n, r) {
    ...
    if (o == e.index(r) && r < t.depth - n.openStart) {
        ...
        if (!n.openStart && !n.openEnd && t.depth == r && e.depth == r) {
            ...
            let { start: s, end: l } = $p(n, t);
            return jt(i, lc(t, s, l, e, r));
        }
    else return jt(i, Qr(t, e, r));
}
function sc(t, e) {
...
function Jn(t, e, n, r) {
    ...
    t &&
        ((i = t.index(n)),
        t.depth > n ? i++ : t.textOffset && (Wt(t.nodeAfter, r), i++));
    for (let l = i; l < s; l++) Wt(o.child(l), r);
    e && e.depth == n && e.textOffset && Wt(e.nodeBefore, r);
}
function jt(t, e) {
    return (t.type.checkContent(e), t.copy(e));
}
function lc(t, e, n, r, o) {
    let i = t.depth > o && es(t, e, o + 1),
        s = r.depth > o && es(n, r, o + 1),
        l = [];
    return (
        Jn(null, t, o, l),
        i && s && e.index(o) == n.index(o)
            ? (sc(i, s), Wt(jt(i, lc(t, e, n, r, o + 1)), l))
            : (i && Wt(jt(i, Qr(t, e, o + 1)), l),
              Jn(e, n, o, l),
              s && Wt(jt(s, Qr(n, r, o + 1)), l)),
        Jn(r, null, o, l),
        new v(l)
    );
}
function Qr(t, e, n) {
    let r = [];
    if ((Jn(null, t, n, r), t.depth > n)) {
        let o = es(t, e, n + 1);
        Wt(jt(o, Qr(t, e, n + 1)), r);
    }
    return (Jn(e, null, n, r), new v(r));
}
function $p(t, e) {
...
var Xn = class t {
        ...
        static resolveCached(e, n) {
            ...
            else Ka.set(e, (r = new ts()));
            let o = (r.elts[r.i] = t.resolve(e, n));
            return ((r.i = (r.i + 1) % Fp), o);
        }
    },
    ts = class {
        constructor() {
    ...
    te = class t {
        ...
        hasMarkup(e, n, r) {
            return (
                this.type == e &&
                Yr(this.attrs, n || e.defaultAttrs || Vp) &&
        ...
        slice(e, n = this.content.size, r = !1) {
            if (e == n) return N.empty;
            let o = this.resolve(e),
                i = this.resolve(n),
                s = r ? 0 : o.sharedDepth(n),
                l = o.start(s),
                c = o.node(s).content.cut(o.pos - l, i.pos - l);
            return new N(c, o.depth - s, i.depth - s);
        }
        replace(e, n, r) {
            return Hp(this.resolve(e), this.resolve(n), r);
        }
        nodeAt(e) {
            for (let n = this; ; ) {
        ...
        resolve(e) {
            return Xn.resolveCached(this, e);
        }
        resolveNoCache(e) {
            return Xn.resolve(this, e);
        }
        rangeHasMark(e, n, r) {
            let o = !1;
            return (
...
var ns = class t extends te {
    ...
    toString() {
        return this.type.spec.toDebugString
            ...
            : ac(this.marks, JSON.stringify(this.text));
    }
    get textContent() {
        return this.text;
    }
...
function pc(t, e) {
    let n = Object.create(null);
    if (e) for (let r in e) n[r] = new is(t, r, e[r]);
    return n;
}
var Yn = class t {
    constructor(e, n, r) {
        ((this.name = e),
            ...
            (this.attrs = pc(e, r.attrs)),
            (this.defaultAttrs = uc(this.attrs)),
    ...
    computeAttrs(e) {
        return !e && this.defaultAttrs ? this.defaultAttrs : fc(this.attrs, e);
    }
    create(e = null, n, r) {
        if (this.isText)
    ...
    checkAttrs(e) {
        hc(this.attrs, e, "node", this.name);
    }
    allowsMarkType(e) {
...
var is = class {
    ...
    gn = class t {
        ...
        checkAttrs(e) {
            hc(this.attrs, e, "mark", this.name);
        }
        excludes(e) {
    ...
    Ut = class {
        constructor(e) {
            ...
            ((n.nodes = Yi.from(e.nodes)),
                ...
                (this.nodes = Yn.compile(this.spec.nodes, this)),
                (this.marks = gn.compile(this.spec.marks, this)));
            let r = Object.create(null);
        ...
        text(e, n) {
            ...
            return new ns(r, r.defaultAttrs, e, G.setFrom(n));
        }
        mark(e, n) {
...
var Ae = class t {
        ...
        parse(e, n = {}) {
            let r = new Zr(this, n, !1);
            return (r.addAll(e, G.none, n.from, n.to), r.finish());
        }
        parseSlice(e, n = {}) {
            let r = new Zr(this, n, !0);
            return (r.addAll(e, G.none, n.from, n.to), N.maxOpen(r.finish()));
        }
        matchTag(e, n, r) {
            for (
...
var mn = class {
        constructor(e, n, r, o, i, s) {
            ((this.type = e),
                ...
                (this.match = i || (s & Gn ? null : e.contentMatch)));
        }
        findWrapping(e) {
            if (!this.match) {
                if (!this.type) return [];
        ...
        inlineContext(e) {
            return this.type
                ...
                : this.content.length
                  ...
                  : e.parentNode &&
                    !mc.hasOwnProperty(e.parentNode.nodeName.toLowerCase());
        }
    },
    Zr = class {
        constructor(e, n, r) {
            ...
            let o = n.topNode,
                i,
                s = Xa(null, n.preserveWhitespace, 0) | (r ? Gn : 0);
            (o
                ? (i = new mn(
                      o.type,
                      o.attrs,
                ...
                : r
                  ? (i = new mn(null, null, G.none, !0, null, s))
                  : (i = new mn(
        ...
        addTextNode(e, n) {
            let r = e.nodeValue,
                ...
                i =
                    o.options & ss
                        ? "full"
                        : this.localPreserveWS || (o.options & Qn) > 0,
...
`,
        ...
        addElement(e, n, r) {
            ...
            let s = e.nodeName.toLowerCase(),
                l;
            gc.hasOwnProperty(s) && this.parser.normalizeLists && em(e);
            let a =
                (this.options.ruleFromNode && this.options.ruleFromNode(e)) ||
                (l = this.parser.matchTag(e, this, r));
            e: if (a ? a.ignore : Zp.hasOwnProperty(s))
...
`),
            ...
            if (o) {
                ...
                for (let l of o.concat(e.marks))
                    (i.type
                        ...
                        : Qa(l.type, e.type)) && (s = l.addToSet(s));
        ...
        enterInner(e, n, r, o = !1, i) {
            ...
            let l = Xa(e, i, s.options);
            s.options & Gn && s.content.length == 0 && (l |= Gn);
            let a = G.none;
            return (
                (r = r.filter((c) =>
                    (s.type ? s.type.allowsMarkType(c.type) : Qa(c.type, e))
                        ? ((a = c.addToSet(a)), !1)
                        : !0,
                )),
                this.nodes.push(new mn(e, n, a, o, null, l)),
                this.open++,
                r
            );
        }
        ...
        sync(e) {
            for (let n = this.open; n >= 0; n--) {
                ...
                this.localPreserveWS && (this.nodes[n].options |= Qn);
            }
            return !1;
        }
        get currentPos() {
...
var et = class t {
    ...
    serializeFragment(e, n = {}, r) {
        r || (r = Zi(n).createDocumentFragment());
        let o = r,
            i = [];
        return (
            e.forEach((s) => {
    ...
    serializeMark(e, n, r = {}) {
        ...
        return o && Xr(Zi(r), o(e, n), null, e.attrs);
    }
...
function nm(t) {
    let e = ec.get(t);
    return (e === void 0 && ec.set(t, (e = rm(t))), e);
}
function rm(t) {
    let e = null;
    function n(r) {
...
function Xr(t, e, n, r) {
    ...
    for (let u = d; u < e.length; u++) {
        ...
        if (f === 0) {
            ...
            let { dom: h, contentDOM: p } = Xr(t, f, n, r);
...
var kc = 1,
    ...
    tr = class {
        ...
        get deletedBefore() {
            return (this.delInfo & (kc | eo)) > 0;
        }
        get deletedAfter() {
            return (this.delInfo & (Sc | eo)) > 0;
        }
        get deletedAcross() {
            return (this.delInfo & eo) > 0;
        }
    },
    ft = class t {
        constructor(e, n = !1) {
        ...
        _map(e, n, r) {
            ...
            for (let l = 0; l < this.ranges.length; l += 3) {
                ...
                if (e <= u) {
                    let f = c ? (e == a ? -1 : e == u ? 1 : n) : n,
                        h = a + o + (f < 0 ? 0 : d);
                    if (r) return h;
                    let p = e == (n < 0 ? a : u) ? null : om(l / 3, e - a),
                        m = e == a ? Sc : e == u ? kc : eo;
                    return (
                        (n < 0 ? e != a : e != u) && (m |= Cc),
                        new tr(h, m, p)
            ...
            return r ? e + o : new tr(e + o, 0, null);
        }
        touches(e, n) {
            let r = 0,
                o = yc(n),
...
function fs(t, e, n) {
    ...
    for (let o = 0; o < t.childCount; o++) {
        let i = t.child(o);
        (i.content.size && (i = i.copy(fs(i.content, e, i))),
            i.isInline && (i = e(i, n, o)),
            r.push(i));
    }
    return v.fromArray(r);
}
var rr = class t extends de {
    constructor(e, n, r) {
...
var or = class t extends de {
    constructor(e, n) {
        (super(), (this.pos = e), (this.mark = n));
    }
    apply(e) {
        let n = e.nodeAt(this.pos);
        if (!n) return fe.fail("No node at mark step's position");
        let r = n.type.create(n.attrs, null, this.mark.addToSet(n.marks));
        return fe.fromReplace(
            e,
            this.pos,
            this.pos + 1,
            new N(v.from(r), 0, n.isLeaf ? 0 : 1),
        );
    }
    invert(e) {
        let n = e.nodeAt(this.pos);
...
de.jsonID("addNodeMark", or);
var yn = class t extends de {
    constructor(e, n) {
        (super(), (this.pos = e), (this.mark = n));
    }
    apply(e) {
...
de.jsonID("removeNodeMark", yn);
var ye = class t extends de {
    ...
    apply(e) {
        return this.structure && ds(e, this.from, this.to)
            ? fe.fail("Structure replace would overwrite content")
            : fe.fromReplace(e, this.from, this.to, this.slice);
    }
    getMap() {
    ...
    static fromJSON(e, n) {
        ...
        return new t(n.from, n.to, N.fromJSON(e, n.slice), !!n.structure);
    }
};
de.jsonID("replace", ye);
var le = class t extends de {
    ...
    apply(e) {
        if (
            this.structure &&
            (ds(e, this.from, this.gapFrom) || ds(e, this.gapTo, this.to))
        )
            return fe.fail("Structure gap-replace would overwrite content");
        let n = e.slice(this.gapFrom, this.gapTo);
        if (n.openStart || n.openEnd) return fe.fail("Gap is not a flat range");
        let r = this.slice.insertAt(this.insert, n.content);
        return r
            ? fe.fromReplace(e, this.from, this.to, r)
            : fe.fail("Content does not fit in gap");
    }
    getMap() {
        return new ft([
            this.from,
...
function sm(t, e, n, r) {
    ...
    (t.doc.nodesBetween(e, n, (a, c, d) => {
        ...
        if (!r.isInSet(u) && d.type.allowsMarkType(r.type)) {
            ...
            l && l.to == f ? (l.to = h) : i.push((l = new rr(f, h, r)));
        }
    }),
...
function hs(t, e, n, r = n.contentMatch, o = !0) {
    ...
    for (let a = 0; a < i.childCount; a++) {
        ...
        if (!u) s.push(new ye(l, d, N.empty));
        else {
            r = u;
...
function pt(t) {
    ...
    for (let r = t.depth, o = 0, i = 0; ; --r) {
        ...
        if (r == 0 || s.type.spec.isolating || !am(s, l, a)) break;
...
function cm(t, e, n) {
    ...
    for (let p = i, m = !1; p > n; p--)
        m || o.after(p + 1) < o.end(p)
            ...
            : c++;
    t.step(new le(a, c, s, l, new N(d.append(f), u, h), d.size - u, !0));
}
function wn(t, e, n = null, r = t) {
    let o = dm(t, e),
        i = o && um(r, e);
    return i ? o.map(bc).concat({ type: e, attrs: n }).concat(i.map(bc)) : null;
}
function bc(t) {
...
function fm(t, e, n) {
    ...
    let o = e.start,
        i = e.end;
    t.step(new le(o, i, o, i, new N(r, 0, 0), n.length, !0));
}
function hm(t, e, n, r, o) {
    ...
    t.doc.nodesBetween(e, n, (s, l) => {
        ...
        if (
            s.isTextblock &&
            !s.hasMarkup(r, a) &&
            pm(t.doc, t.mapping.slice(i).map(l), r)
        ) {
            let c = null;
            ...
            (c === !1 && Mc(t, s, l, i),
                hs(t, t.mapping.slice(i).map(l, 1), r, void 0, c === null));
            ...
            return (
                t.step(
                    new le(
                        ...
                        u + 1,
                        f - 1,
                        new N(v.from(r.create(a, null, s.marks)), 0, 0),
                        1,
                        !0,
                    ),
                ),
...
function gm(t, e, n = 1, r) {
    ...
    t.step(new ye(e, e, new N(i.append(s), n, n), !0));
}
function Le(t, e) {
    let n = t.resolve(e),
        r = n.index();
    return Tc(n.nodeBefore, n.nodeAfter) && n.parent.canReplace(r, r + 1);
}
function ym(t, e) {
...
function Kt(t, e, n = -1) {
    ...
    for (let o = r.depth; ; o--) {
        ...
        if (
            ...
            i && !i.isTextblock && Tc(i, s) && r.node(o).canReplace(l, l + 1))
        )
            return e;
        if (o == 0) break;
...
function bm(t, e, n) {
    ...
    if (r === !1) {
        ...
        Mc(t, d.node(), d.before(), l);
    }
    s.inlineContent &&
        hs(t, e + n - 1, s, i.node().contentMatchAt(i.index()), r == null);
    let a = t.mapping.slice(l),
        c = a.map(e - n);
    if ((t.step(new ye(c, a.map(e + n, -1), N.empty, !0)), r === !0)) {
        let d = t.doc.resolve(c);
        vc(t, d.node(), d.before(), t.steps.length);
    }
    return t;
}
function wm(t, e, n) {
...
function ir(t, e, n = e, r = N.empty) {
    if (e == n && !r.size) return null;
    let o = t.resolve(e),
        i = t.resolve(n);
    return Ac(o, i, r) ? new ye(e, n, r) : new us(o, i, r).fit();
}
function Ac(t, e, n) {
    return (
        !n.openStart &&
...
var us = class {
        ...
        for (let n = 1; n <= 2; n++)
            for (let r = n == 1 ? e : this.unplaced.openStart; r >= 0; r--) {
                let o,
                    i = null;
                r
                    ? ((i = as(this.unplaced.content, r - 1).firstChild),
                      (o = i.content))
    ...
    dropNode() {
        ...
        if (o.childCount <= 1 && n > 0) {
            ...
            this.unplaced = new N(Zn(e, n - 1, 1), n - 1, i ? n - 1 : r);
        } else this.unplaced = new N(Zn(e, n, 1), n, r);
    }
    placeNodes({
        sliceDepth: e,
        frontierDepth: n,
        ...
        (p || (h = -1),
            (this.placed = er(this.placed, n, v.from(d))),
        ...
        this.unplaced = p
            ...
            : new N(Zn(s.content, e, c), s.openStart, s.openEnd);
    }
    mustMoveInline() {
    ...
    close(e) {
        ...
        (n.fit.childCount && (this.placed = er(this.placed, n.depth, n.fit)),
            (e = n.move));
    ...
    openFrontierNode(e, n = null, r) {
        ...
        ((o.match = o.match.matchType(e)),
            (this.placed = er(this.placed, this.depth, v.from(e.create(n, r)))),
            this.frontier.push({ type: e, match: e.contentMatch }));
    }
    closeFrontierNode() {
        let n = this.frontier.pop().match.fillBefore(v.empty, !0);
        n.childCount &&
            (this.placed = er(this.placed, this.frontier.length, n));
    }
};
function Zn(t, e, n) {
    return e == 0
        ...
        : t.replaceChild(
              0,
              t.firstChild.copy(Zn(t.firstChild.content, e - 1, n)),
          );
}
function er(t, e, n) {
    return e == 0
        ...
        : t.replaceChild(
              t.childCount - 1,
              t.lastChild.copy(er(t.lastChild.content, e - 1, n)),
          );
}
function as(t, e) {
...
function Ec(t, e, n) {
    ...
    return (
        e > 1 &&
            (r = r.replaceChild(
                0,
                Ec(r.firstChild, e - 1, r.childCount == 1 ? n - 1 : 0),
            )),
        e > 0 &&
...
function cs(t, e, n, r, o) {
    ...
    return l && !xm(n, i.content, s) ? l : null;
}
function xm(t, e, n) {
...
function Sm(t, e, n, r) {
    ...
    let o = t.doc.resolve(e),
        i = t.doc.resolve(n);
    if (Ac(o, i, r)) return t.step(new ye(e, n, r));
    let s = Oc(o, i);
            ...
            for (let m = 0; m < s.length; m++) {
                ...
                if (b.canReplaceWith(w, w, p.type, p.marks))
                    return t.replace(
                        o.before(g),
                        y ? i.after(g) : n,
                        new N(Nc(r.content, 0, r.openStart, h), h, r.openEnd),
                    );
            }
    }
...
function Nc(t, e, n, r, o) {
    if (e < n) {
        let i = t.firstChild;
        t = t.replaceChild(0, i.copy(Nc(i.content, e + 1, n, r, i)));
    }
    if (e > r) {
...
function Cm(t, e, n, r) {
    if (!r.isInline && e == n && t.doc.resolve(e).parent.content.size) {
        let o = wm(t.doc, e, r.type);
        o != null && (e = n = o);
    }
    t.replaceRange(e, n, new N(v.from(r), 0, 0));
}
function vm(t, e, n) {
...
var to = class t extends de {
    constructor(e, n, r) {
        (super(), (this.pos = e), (this.attr = n), (this.value = r));
    }
    apply(e) {
        let n = e.nodeAt(this.pos);
        if (!n) return fe.fail("No node at attribute step's position");
        let r = Object.create(null);
...
bn.prototype.name = "TransformError";
var Ot = class {
    constructor(e) {
        ((this.doc = e),
            (this.steps = []),
    ...
    step(e) {
        ...
        if (n.failed) throw new bn(n.failed);
        return this;
    }
    maybeStep(e) {
    ...
    replace(e, n = e, r = N.empty) {
        let o = ir(this.doc, e, n, r);
        return (o && this.step(o), this);
    }
    replaceWith(e, n, r) {
        return this.replace(e, n, new N(v.from(r), 0, 0));
    }
    delete(e, n) {
    ...
    setBlockType(e, n = e, r, o = null) {
        return (hm(this, e, n, r, o), this);
    }
    setNodeMarkup(e, n, r = null, o) {
        return (mm(this, e, n, r, o), this);
    }
    setNodeAttribute(e, n, r) {
        return (this.step(new to(e, n, r)), this);
    }
    setDocAttribute(e, n) {
    ...
    removeNodeMark(e, n) {
        ...
        if (n instanceof G) n.isInSet(r.marks) && this.step(new yn(e, n));
        else {
            let o = r.marks,
                i,
                s = [];
            for (; (i = n.isInSet(o)); )
                (s.push(new yn(e, i)), (o = i.removeFromSet(o)));
            for (let l = s.length - 1; l >= 0; l--) this.step(s[l]);
        }
        return this;
    }
    split(e, n = 1, r) {
        return (gm(this, e, n, r), this);
    }
    addMark(e, n, r) {
        return (sm(this, e, n, r), this);
    }
    removeMark(e, n, r) {
        return (lm(this, e, n, r), this);
    }
...
var ps = Object.create(null),
    L = class {
        constructor(e, n, r) {
            ((this.$anchor = e),
                (this.$head = n),
                (this.ranges = r || [new Jt(e.min(n), e.max(n))]));
        }
        get anchor() {
        ...
        replace(e, n = N.empty) {
            ...
            for (let l = 0; l < s.length; l++) {
                let { $from: a, $to: c } = s[l],
                    d = e.mapping.slice(i);
                (e.replaceRange(d.map(a.pos), d.map(c.pos), l ? N.empty : n),
                    l == 0 &&
                        Ic(
                            e,
                            i,
            ...
            for (let i = 0; i < o.length; i++) {
                ...
                i
                    ...
                    : (e.replaceRangeWith(c, d, n),
                      Ic(e, r, n.isInline ? -1 : 1));
            }
        }
        static findFrom(e, n, r = !1) {
            let o = e.parent.inlineContent
                ? new D(e)
                : xn(e.node(0), e.parent, e.pos, e.index(), n, r);
            if (o) return o;
        ...
        static atStart(e) {
            return xn(e, e, 0, 0, 1) || new be(e);
        }
        static atEnd(e) {
            return xn(e, e, e.content.size, e.childCount, -1) || new be(e);
        }
        static fromJSON(e, n) {
            if (!n || !n.type)
...
var D = class t extends L {
    ...
    static between(e, n, r) {
        ...
        if (((!r || o) && (r = o >= 0 ? 1 : -1), !n.parent.inlineContent)) {
            let i = L.findFrom(n, r, !0) || L.findFrom(n, -r, !0);
            if (i) n = i.$head;
        ...
        return (
            e.parent.inlineContent ||
                (o == 0
                    ? (e = n)
                    : ((e = (L.findFrom(e, -r, !0) || L.findFrom(e, r, !0))
                          .$anchor),
                      e.pos < n.pos != o < 0 && (e = n))),
            new t(e, n)
        );
...
var io = class t {
    ...
    I = class t extends L {
        ...
        content() {
            return new N(v.from(this.node), 0, 0);
        }
        eq(e) {
...
var gs = class t {
        ...
        map(e) {
            ...
            return n ? new io(r, r) : new t(r);
        }
        resolve(e) {
            let n = e.resolve(this.anchor),
                r = n.nodeAfter;
            return r && I.isSelectable(r) ? new I(n) : L.near(n);
        }
    },
...
function xn(t, e, n, r, o, i = !1) {
    ...
    for (
        ...
        if (l.isAtom) {
            ...
            let a = xn(t, l, n + o, o < 0 ? l.childCount : 0, o, i);
            if (a) return a;
        }
        n += l.nodeSize * o;
    }
...
function Ic(t, e, n) {
    ...
    if (r < e) return;
    let o = t.steps[r];
    if (!(o instanceof ye || o instanceof le)) return;
    let i = t.mapping.maps[r],
        s;
    (i.forEach((l, a, c, d) => {
        s == null && (s = d);
    }),
        t.setSelection(L.near(t.doc.resolve(s), n)));
}
var Pc = 1,
    oo = 2,
    Lc = 4,
    so = class extends Ot {
        ...
        setSelection(e) {
            ...
            return (
                (this.curSelection = e),
                (this.curSelectionFor = this.steps.length),
                (this.updated = (this.updated | Pc) & ~oo),
                    ...
                    : this.deleteSelection();
            {
                ...
                return (
                    ...
                    !this.selection.empty &&
                        ...
                        this.setSelection(L.near(this.selection.$to)),
                    this
                );
            }
        }
...
var qt = class {
        constructor(e, n, r) {
            ((this.name = e),
                (this.init = Bc(n.init, r)),
                (this.apply = Bc(n.apply, r)));
        }
    },
    Tm = [
        new qt("doc", {
            ...
            return (
                o.fields.forEach((s) => {
                    if (s.name == "doc") i.doc = te.fromJSON(e.schema, n.doc);
                        ...
                        i.selection = L.fromJSON(i.doc, n.selection);
...
var P = class {
        constructor(e) {
            ((this.spec = e),
                (this.props = {}),
                e.props && zc(e.props, this, this.props),
                (this.key = e.key ? e.key.key : Hc("plugin")));
        }
        getState(e) {
            return e[this.key];
        }
...
var bs = (t, e, n) => {
        ...
        let i = o.nodeBefore;
        if (Gc(t, o, e, -1)) return !0;
        if (r.parent.content.size == 0 && (kn(i, "end") || I.isSelectable(i)))
            for (let s = r.depth; ; s--) {
                let l = ir(t.doc, r.before(s), r.after(s), N.empty);
                    ...
                    if (e) {
                        ...
                        (a.setSelection(
                            kn(i, "end")
                                ...
                                : I.create(a.doc, o.pos - i.nodeSize),
                        ),
                            e(a.scrollIntoView()));
                    }
                    return !0;
...
var ws = (t, e, n) => {
    ...
    return !s || !I.isSelectable(s)
        ? !1
        : (e &&
              e(
                  t.tr
                      .setSelection(I.create(t.doc, i.pos - s.nodeSize))
                      .scrollIntoView(),
              ),
          !0);
};
...
var ks = (t, e, n) => {
        ...
        if (
            ...
            (kn(i, "start") || I.isSelectable(i))
        ) {
            let s = ir(t.doc, r.before(), r.after(), N.empty);
            if (s && s.slice.size < s.to - s.from) {
                if (e) {
                    let l = t.tr.step(s);
                    (l.setSelection(
                        kn(i, "start")
                            ? L.findFrom(l.doc.resolve(l.mapping.map(o.pos)), 1)
                            : I.create(l.doc, l.mapping.map(o.pos)),
                    ),
                        e(l.scrollIntoView()));
                }
                return !0;
    ...
    Ss = (t, e, n) => {
        ...
        return !s || !I.isSelectable(s)
            ? !1
            : (e &&
                  e(t.tr.setSelection(I.create(t.doc, i.pos)).scrollIntoView()),
              !0);
    };
function Cs(t) {
    if (!t.parent.type.spec.isolating)
...
var Uc = (t, e) => {
        ...
        if (r) {
            ...
            o = n.from;
        } else if (((o = Kt(t.doc, n.from, -1)), o == null)) return !1;
        if (e) {
            let i = t.tr.join(o);
            (r &&
                i.setSelection(
                    I.create(i.doc, o - t.doc.resolve(o).nodeBefore.nodeSize),
                ),
                e(i.scrollIntoView()));
        }
        return !0;
    ...
    Kc = (t, e) => {
        ...
        if (n instanceof I) {
            ...
            r = n.to;
        } else if (((r = Kt(t.doc, n.to, 1)), r == null)) return !1;
...
var Ts = (t, e) => {
        ...
        if (e) {
            ...
            (a.setSelection(L.near(a.doc.resolve(l), 1)),
                e(a.scrollIntoView()));
        }
        return !0;
    },
...
function Am(t) {
    return (e, n) => {
        ...
        let d = e.tr;
        (e.selection instanceof D || e.selection instanceof be) &&
            d.deleteSelection();
...
var Jc = (t, e) => {
        ...
        return i == 0
            ? !1
            : ((o = n.before(i)),
              e && e(t.tr.setSelection(I.create(t.doc, o))),
              !0);
    },
    Nm = (t, e) => (e && e(t.tr.setSelection(new be(t.doc))), !0);
function Om(t, e, n) {
    let r = e.nodeBefore,
        o = e.nodeAfter,
        i = e.index();
...
function Gc(t, e, n, r) {
    ...
    let d = i.type.spec.isolating || (r > 0 && a) ? null : L.findFrom(e, 1),
        u = d && d.$from.blockRange(d.$to),
        f = u && pt(u);
    if (f != null && f >= e.depth)
        return (n && n(t.tr.lift(u, f).scrollIntoView()), !0);
    if (c && kn(i, "start", !0) && kn(o, "end")) {
        let h = o,
            p = [];
...
function Qc(t, e = null) {
    return function (n, r) {
        ...
        if (!s) return !1;
        let l = r ? n.tr : null;
        return Dm(l, s, t, e) ? (r && r(l.scrollIntoView()), !0) : !1;
    };
}
function Dm(t, e, n, r = null) {
    let o = !1,
        i = e,
        s = e.$from.doc;
    if (
...
function Im(t, e, n, r, o) {
    ...
    for (let d = e.startIndex, u = e.endIndex, f = !0; d < u; d++, f = !1)
        (!f && Re(t.doc, a, l) && (t.split(a, l), (a += 2 * l)),
    ...
    i < s &&
        (o.step(
            new le(
                ...
                i,
                s,
                new N(v.from(n.create(null, r.parent.copy())), 1, 0),
                1,
                !0,
            ),
        ),
...
function ed(t) {
    return function (e, n) {
        ...
        if (n) {
            ...
            n(
                e.tr
                    .step(new le(f - (c ? 3 : 1), h, f, h, u, 1, !0))
                    .scrollIntoView(),
            );
        }
        return !0;
...
var he = function (t) {
    ...
    $s = null,
    gt = function (t, e, n) {
        let r = $s || ($s = document.createRange());
...
function Hm(t, e) {
    for (;;) {
        ...
        } else if (t.parentNode && !mr(t)) ((e = he(t)), (t = t.parentNode));
        else return null;
    }
}
function $m(t, e) {
...
var wo = function (t) {
    return (
        t.focusNode &&
        tn(t.focusNode, t.focusOffset, t.anchorNode, t.anchorOffset)
    );
};
function Gt(t, e) {
    ...
    if (t.caretPositionFromPoint)
        try {
            ...
            if (r)
                return {
                    node: r.offsetNode,
                    offset: Math.min(ze(r.offsetNode), r.offset),
                };
        } catch {}
...
var tt = typeof navigator < "u" ? navigator : null,
    nd = typeof document < "u" ? document : null,
    zt = (tt && tt.userAgent) || "",
    Fs = /Edge\/(\d+)/.exec(zt),
    Pd = /MSIE \d/.exec(zt),
    Vs = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(zt),
    Ee = !!(Pd || Vs || Fs),
    Lt = Pd ? document.documentMode : Vs ? +Vs[1] : Fs ? +Fs[1] : 0,
    He = !Ee && /gecko\/(\d+)/i.test(zt);
He && +(/Firefox\/(\d+)/.exec(zt) || [0, 0])[1];
var _s = !Ee && /Chrome\/(\d+)/.exec(zt),
    ue = !!_s,
    Ld = _s ? +_s[1] : 0,
    xe = !Ee && !!tt && /Apple Computer/.test(tt.vendor),
    An = xe && (/Mobile\/\w+/.test(zt) || (!!tt && tt.maxTouchPoints > 2)),
    Be = An || (tt ? /Mac/.test(tt.platform) : !1),
    Bd = tt ? /Win/.test(tt.platform) : !1,
    yt = /Android \d/.test(zt),
    gr = !!nd && "webkitFontSmoothing" in nd.documentElement.style,
    Wm = gr
...
function rd(t, e, n) {
    ...
    for (let s = n || t.dom; s; ) {
        ...
        s = f == "absolute" ? s.offsetParent : Tn(s);
    }
}
function Km(t) {
    ...
    return { refDOM: r, refTop: o, stack: zd(t.dom) };
}
function zd(t) {
    let e = [],
        n = t.ownerDocument;
...
function qm({ refDOM: t, refTop: e, stack: n }) {
...
function Jm(t) {
    ...
    if (Sn) return t.focus(Sn);
    let e = zd(t);
    (t.focus(
        Sn == null
            ? {
                  get preventScroll() {
                      return ((Sn = { preventScroll: !0 }), !0);
                  },
              }
            : void 0,
    ),
...
function Zm(t, e) {
    ...
    if (!s || !t.dom.contains(s.nodeType != 1 ? s.parentNode : s)) {
        ...
        if (!rl(e, c) || ((s = Fd(t.dom, e, c)), !s)) return null;
    }
    if (xe) for (let c = s; r && c; c = Tn(c)) c.draggable && (r = void 0);
    if (((s = Xm(s, e)), r)) {
        if (
            He &&
            r.nodeType == 1 &&
...
function Dt(t, e) {
    ...
    return Array.prototype.find.call(n, od) || t.getBoundingClientRect();
}
var eg = /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac]/;
function Vd(t, e, n) {
    let {
    ...
    if (r.nodeType == 3)
        if (
            s &&
            (eg.test(r.nodeValue) || (n < 0 ? !o : o == r.nodeValue.length))
        ) {
            let a = Dt(gt(r, o, o), n);
            if (
                He &&
                ...
                let c = Dt(gt(r, o - 1, o - 1), -1);
                if (c.top == a.top) {
                    let d = Dt(gt(r, o, o + 1), -1);
                    if (d.top != a.top) return ar(d, d.left < c.left);
                }
            }
            return a;
        } else {
                ...
                n < 0 && !o
                    ...
                    : n >= 0 && o == r.nodeValue.length
                      ...
                      : n < 0
                        ? a--
                        : c++,
                ar(Dt(gt(r, a, c), d), d < 0)
            );
        }
    if (!t.state.doc.resolve(e - (i || 0)).parent.inlineContent) {
        if (i == null && o && (n < 0 || o == ze(r))) {
            let a = r.childNodes[o - 1];
            if (a.nodeType == 1) return Ps(a.getBoundingClientRect(), !1);
        }
        if (i == null && o < ze(r)) {
            let a = r.childNodes[o];
            if (a.nodeType == 1) return Ps(a.getBoundingClientRect(), !0);
        }
        return Ps(r.getBoundingClientRect(), n >= 0);
    }
    if (i == null && o && (n < 0 || o == ze(r))) {
        let a = r.childNodes[o - 1],
            c =
        ...
        let c = a
            ? a.nodeType == 3
                ...
                : a.nodeType == 1
                  ...
                  : null
            : null;
        if (c) return ar(Dt(c, -1), !0);
    }
    return ar(Dt(r.nodeType == 3 ? gt(r) : r, -n), n >= 0);
}
function ar(t, e) {
...
function rg(t, e, n) {
    ...
    let o = r.parentOffset,
        ...
        l = t.domSelection();
    return l
        ? !ng.test(r.parent.textContent) || !l.modify
            ? n == "left" || n == "backward"
                ? i
                : s
            : _d(t, e, () => {
...
function og(t, e, n) {
    return id == e && sd == n
        ...
        : ((id = e),
          (sd = n),
          (ld = n == "up" || n == "down" ? tg(t, e, n) : rg(t, e, n)));
}
var $e = 0,
    ad = 1,
    Xt = 2,
    ...
    nn = class {
        ...
        localPosFromDOM(e, n, r) {
            ...
            let o;
            if (e == this.dom && this.contentDOM) o = n > he(this.contentDOM);
            else if (
                this.contentDOM &&
        ...
        domFromPos(e, n) {
            ...
            if (n <= 0) {
                ...
                return i && n && s && !i.border && !i.domAtom
                    ...
                    : { node: this.contentDOM, offset: i ? he(i.dom) + 1 : 0 };
            } else {
                let i,
                    s = !0;
                for (
...
`
            ...
            if (
                !(o || (u && xe)) &&
                tn(l.node, l.offset, d.anchorNode, d.anchorOffset) &&
                tn(a.node, a.offset, d.focusNode, d.focusOffset)
            )
                return;
            let f = !1;
    ...
    En = class t extends nn {
        ...
        parseRule() {
            return this.dirty & nt || this.mark.type.spec.reparseInView
                ? null
                : {
        ...
        slice(e, n, r) {
            let o = t.create(this.parent, this.mark, !0, r),
                i = this.children,
                s = this.size;
            (n < s && (i = qs(i, n, s, r)), e > 0 && (i = qs(i, 0, e, r)));
    ...
    Bt = class t extends nn {
        ...
        static create(e, n, r, o, i, s) {
            ...
            if (n.isText) {
                ...
                d ||
                    ({ dom: d, contentDOM: u } = et.renderSpec(
                        document,
                        n.type.spec.toDOM(n),
                        null,
                        n.attrs,
            ...
            return (
                (d = Ud(d, r, n)),
                c
                    ? (a = new js(e, n, r, o, d, u || null, f, c, i, s + 1))
                    : n.isText
                      ? new uo(e, n, r, o, d, f, i)
        ...
        updateChildren(e, n) {
            ...
            (ag(
                ...
                (a.changed || this.dirty == Xt) &&
                    ...
                    Wd(this.contentDOM, this.children, e),
                    An && cg(this.dom)));
        }
        localCompositionInfo(e, n) {
            ...
            if (this.node.inlineContent) {
                let s = i.nodeValue,
                    l = dg(this.node.content, s, r - n, o - n);
        ...
        protectLocalComposition(e, { node: n, pos: r, text: o }) {
            ...
            let s = new Ws(this, i, n, o);
            (e.input.compositionNodes.push(s),
                (this.children = qs(this.children, r, r + o.length, e, s)));
        }
        update(e, n, r, o) {
            return this.dirty == nt || !e.sameMarkup(this.node)
                ? !1
        ...
        updateOuterDeco(e) {
            if (ho(e, this.outerDeco)) return;
            let n = this.nodeDOM.nodeType != 1,
                r = this.dom;
            ((this.dom = jd(
                this.dom,
                this.nodeDOM,
                Us(this.outerDeco, this.node, n),
                Us(e, this.node, n),
            )),
                this.dom != r &&
...
function Us(t, e, n) {
    ...
    for (let i = 0; i < t.length; i++) {
        ...
        if (s) {
            s.nodeName && o.push((r = new cr(s.nodeName)));
            for (let l in s) {
                let a = s[l];
                a != null &&
                    (n &&
                        o.length == 1 &&
                        o.push((r = new cr(e.isInline ? "span" : "div"))),
                    l == "class"
...
function Ud(t, e, n) {
    return jd(t, t, Yt, Us(e, n, t.nodeType != 1));
}
function ho(t, e) {
    if (t.length != e.length) return !1;
...
var Ks = class {
    ...
    syncToMarks(e, n, r) {
        ...
        for (; i < e.length; ) {
            ...
            if (l > -1)
                ...
                let a = En.create(this.top, e[i], n, r);
    ...
    updateNodeAt(e, n, r, o, i) {
        ...
        return (
            s.dirty == nt && s.dom == s.contentDOM && (s.dirty = Xt),
            s.update(e, n, r, i)
    ...
    e: for (; o > 0; ) {
        ...
        for (;;)
            if (r) {
                ...
                if (c instanceof En) ((n = c), (r = c.children.length));
                else {
                    ((l = c), r--);
                    break;
                }
...
function ol(t, e = null) {
    ...
    if (wo(n)) {
        ...
        if (
            ...
            I.isSelectable(u) &&
            o.parent &&
            !(u.isInline && Fm(n.focusNode, n.focusOffset, o.dom))
        ) {
            let f = o.posBefore;
    ...
    if ((qd(t, n), !!Kd(t))) {
        if (!e && t.input.mouseDown && t.input.mouseDown.allowDefault && ue) {
            ...
            if (
                r.anchorNode &&
                o.anchorNode &&
                tn(r.anchorNode, r.anchorOffset, o.anchorNode, o.anchorOffset)
            ) {
        ...
        if ((t.domObserver.disconnectSelection(), t.cursorWrapper)) fg(t);
        else {
            ...
            (ud &&
                !(n instanceof D) &&
                (n.$from.parent.inlineContent || (i = fd(t, n.from)),
                !n.empty && !n.$from.parent.inlineContent && (s = fd(t, n.to))),
                ...
                n.visible
                    ...
                    : (t.dom.classList.add("ProseMirror-hideselection"),
                      "onselectionchange" in document && ug(t)));
        }
...
function fd(t, e) {
    ...
    if (xe && o && o.contentEditable == "false") return Ls(o);
    if (
    ...
    e.addEventListener(
        ...
        (t.input.hideSelectionGuard = () => {
            (n.anchorNode != r || n.anchorOffset != o) &&
                ...
                setTimeout(() => {
                    (!Kd(t) || t.state.selection.visible) &&
                        t.dom.classList.remove("ProseMirror-hideselection");
                }, 20));
        }),
    );
...
function fg(t) {
    ...
    let n = t.cursorWrapper.dom,
        r = n.nodeName == "IMG";
    (r ? e.collapse(n.parentNode, he(n) + 1) : e.collapse(n, 0),
        !r &&
...
function qd(t, e) {
    if (e instanceof I) {
        ...
        n != t.lastSelectedViewDesc &&
            (pd(t), n && n.selectNode(), (t.lastSelectedViewDesc = n));
    } else pd(t);
}
function pd(t) {
...
function md(t) {
    return t.editable && !t.hasFocus() ? !1 : Jd(t);
}
function Jd(t) {
...
function hg(t) {
    ...
    return tn(e.node, e.offset, n.anchorNode, n.anchorOffset);
}
function Js(t, e) {
...
function gd(t, e, n) {
    ...
    if (r instanceof D)
        if (n.indexOf("s") > -1) {
            ...
            return It(t, new D(r.$anchor, s));
        } else if (r.empty) {
            if (t.endOfTextblock(e > 0 ? "forward" : "backward")) {
                let o = Js(t.state, e);
                return o && o instanceof I ? It(t, o) : !1;
        ...
        if (r instanceof I && r.node.isInline)
            return It(t, new D(e > 0 ? r.$to : r.$from));
        {
            let o = Js(t.state, e);
            return o ? It(t, o) : !1;
        }
    ...
    for (
        ...
        if (r > 0) {
            ...
            if (Gd(n)) break;
            {
                ...
                for (; l && dr(l, -1); )
                    ((o = n.parentNode), (i = he(l)), (l = l.previousSibling));
                if (l) ((n = l), (r = po(n)));
                else {
    ...
    for (;;)
        if (r < o) {
            ...
            if (Gd(n)) break;
            {
                let l = n.nextSibling;
                for (; l && dr(l, 1); )
                    ((i = l.parentNode), (s = he(l) + 1), (l = l.nextSibling));
                if (l) ((n = l), (r = 0), (o = po(n)));
                else {
                    if (((n = n.parentNode), n == t.dom)) break;
                    r = o = 0;
...
function yg(t, e) {
    for (; t && !e && !mr(t); ) ((e = he(t)), (t = t.parentNode));
    for (; t && e; ) {
...
function Gs(t, e, n) {
    if (e.nodeType != 3) {
        ...
        (s = gg(e, n))
            ? ((e = s), (n = 0))
            : (i = yg(e, n)) && ((e = i), (n = i.nodeValue.length));
    }
...
function yd(t, e) {
    ...
    if (!(ue || Bd) && n.parent.inlineContent) {
...
function bd(t, e, n) {
    ...
    if (!o.parent.inlineContent || t.endOfTextblock(e < 0 ? "up" : "down")) {
        let s = Js(t.state, e);
        if (s && s instanceof I) return It(t, s);
    }
    if (!o.parent.inlineContent) {
        let s = e < 0 ? o : i,
            l = r instanceof be ? L.near(s, e) : L.findFrom(s, e);
        return l ? It(t, l) : !1;
    }
    return !1;
}
...
function xg(t, e) {
    let n = e.keyCode,
        r = wg(e);
    if (n == 8 || (Be && n == 72 && r == "c")) return wd(t, -1) || Cn(t, -1);
    if ((n == 46 && !e.shiftKey) || (Be && n == 68 && r == "c"))
        return wd(t, 1) || Cn(t, 1);
    if (n == 13 || n == 27) return !0;
    if (n == 37 || (Be && n == 66 && r == "c")) {
        let o =
            n == 37 ? (yd(t, t.state.selection.from) == "ltr" ? -1 : 1) : -1;
        return gd(t, o, r) || Cn(t, o);
    } else if (n == 39 || (Be && n == 70 && r == "c")) {
        let o = n == 39 ? (yd(t, t.state.selection.from) == "ltr" ? 1 : -1) : 1;
        return gd(t, o, r) || Cn(t, o);
    } else {
        if (n == 38 || (Be && n == 80 && r == "c"))
            return bd(t, -1, r) || Cn(t, -1);
        if (n == 40 || (Be && n == 78 && r == "c"))
            return bg(t) || bd(t, 1, r) || Cn(t, 1);
...
function sl(t, e) {
    ...
    let s = t.someProp("clipboardSerializer") || et.fromSchema(t.state.schema),
        l = eu(),
    ...
    let c = a.firstChild,
        d,
        u = 0;
    for (; c && c.nodeType == 1 && (d = Zd[c.nodeName.toLowerCase()]); ) {
...
`,
    ...
    if (
        ...
        l = Tg(kd(l, +d[1], +d[2]), d[4]);
    else if (
        ((l = N.maxOpen(Sg(l.content, o), !0)), l.openStart || l.openEnd)
    ) {
        let u = 0,
            f = 0;
        for (
    ...
    for (let n = e.depth; n >= 0; n--) {
        ...
        if (
            (t.forEach((l) => {
                ...
                if (
                    (c =
                        s.length && i.length && Yd(a, i, l, s[s.length - 1], 0))
                )
                    s[s.length - 1] = c;
                else {
                    s.length &&
                        (s[s.length - 1] = Qd(s[s.length - 1], i.length));
                    let d = Xd(l, a);
...
function Yd(t, e, n, r, o) {
    if (o < t.length && o < e.length && t[o] == e[o]) {
        let i = Yd(t, e, n, r.lastChild, o + 1);
        ...
        if (
            ...
            return r.copy(r.content.append(v.from(Xd(n, t, o + 1))));
    }
}
function Qd(t, e) {
    if (e == 0) return t;
    let n = t.content.replaceChild(t.childCount - 1, Qd(t.lastChild, e - 1)),
...
function kd(t, e, n) {
    return (
        e < t.openStart &&
            (t = new N(
                Xs(t.content, -1, e, t.openStart, 0, t.openEnd),
                e,
                t.openEnd,
            )),
        n < t.openEnd &&
            (t = new N(Xs(t.content, 1, n, t.openEnd, 0, 0), t.openStart, n)),
        t
    );
}
var Zd = {
    ...
    Sd = null;
function eu() {
    return Sd || (Sd = document.implementation.createHTMLDocument("title"));
}
var Bs = null;
function Cg(t) {
...
function Eg(t) {
    ...
    (xe && t.dom.addEventListener("input", () => null), Qs(t));
}
function Pt(t, e) {
    ...
    t.someProp("handleDOMEvents", (e) => {
        for (let n in e)
            t.input.eventHandlers[n] ||
                t.dom.addEventListener(
                    n,
                    (t.input.eventHandlers[n] = (r) => al(t, r)),
                );
    });
}
function al(t, e) {
...
ve.keydown = (t, e) => {
    ...
    if (
        ...
        if (
            ...
            An && n.keyCode == 13 && !n.ctrlKey && !n.altKey && !n.metaKey)
        ) {
            let r = Date.now();
            ...
            t.someProp("handleKeyDown", (r) => r(t, n)) || xg(t, n)
                ? n.preventDefault()
                : Pt(t, "key");
};
ve.keyup = (t, e) => {
...
function Ig(t, e) {
    ...
    let n = t.state.doc.resolve(e),
        r = n.nodeAfter;
    return r && r.isAtom && I.isSelectable(r)
        ? (Mn(t, new I(n), "pointer"), !0)
        : !1;
}
function Pg(t, e) {
    if (e == -1) return !1;
    ...
    return o != null ? (Mn(t, I.create(t.state.doc, o), "pointer"), !0) : !1;
}
function Lg(t, e, n, r, o) {
    return (
        cl(t, "handleClickOn", e, n, r) ||
...
function Bg(t, e, n, r) {
    return (
        cl(t, "handleDoubleClickOn", e, n, r) ||
        t.someProp("handleDoubleClick", (o) => o(t, e, r))
    );
}
function zg(t, e, n, r) {
    return (
        cl(t, "handleTripleClickOn", e, n, r) ||
...
function Hg(t, e, n) {
    ...
    if (e == -1)
        return r.inlineContent
            ? (Mn(t, D.create(r, 0, r.content.size), "pointer"), !0)
            : !1;
    let o = r.resolve(e);
    for (let i = o.depth + 1; i > 0; i--) {
        let s = i > o.depth ? o.nodeAfter : o.node(i),
            l = o.before(i);
        if (s.inlineContent)
            Mn(t, D.create(r, l + 1, l + 1 + s.content.size), "pointer");
        else if (I.isSelectable(s)) Mn(t, I.create(r, l), "pointer");
        else continue;
        return !0;
    }
}
...
Ce.mousedown = (t, e) => {
    ...
    let s = t.posAtCoords(xo(n));
    s &&
        (i == "singleClick"
            ? (t.input.mouseDown && t.input.mouseDown.done(),
              (t.input.mouseDown = new Zs(t, s, n, !!r)))
            : (i == "doubleClick" ? Bg : zg)(t, s.pos, s.inside, n)
              ? n.preventDefault()
              : Pt(t, "pointer"));
};
var Zs = class {
    constructor(e, n, r, o) {
        ...
        (((r.button == 0 &&
            ...
            (c instanceof I && c.from <= s && c.to > s)) &&
            (this.mightDrag = {
                node: i,
                pos: s,
        ...
        (this.view.root.removeEventListener("mouseup", this.up),
            ...
            this.mightDrag &&
                ...
                this.view.domObserver.start()),
            this.delayedSelectionSync && setTimeout(() => bt(this.view)),
    ...
    up(e) {
        ...
        (this.view.state.doc != this.startDoc &&
            (n = this.view.posAtCoords(xo(e))),
            this.updateAllowDefault(e),
            this.allowDefault || !n
                ? Pt(this.view, "pointer")
                : Lg(this.view, n.pos, n.inside, e, this.selectNode)
                  ? e.preventDefault()
                  : e.button == 0 &&
                      (this.flushed ||
                          (xe &&
                    ...
                    ? (Mn(
                          this.view,
                          L.near(this.view.state.doc.resolve(n.pos)),
                          "pointer",
                      ),
                      e.preventDefault())
                    : Pt(this.view, "pointer"));
...
Ce.touchstart = (t) => {
    ((t.input.lastTouch = Date.now()), dl(t), Pt(t, "pointer"));
};
Ce.touchmove = (t) => {
    ((t.input.lastTouch = Date.now()), Pt(t, "pointer"));
};
Ce.contextmenu = (t) => dl(t);
function nu(t, e) {
    return t.composing
        ? !0
...
function ru(t, e) {
    (clearTimeout(t.input.composingTimeout),
        e > -1 && (t.input.composingTimeout = setTimeout(() => ur(t), e)));
}
function ou(t) {
    for (
        t.composing &&
        ((t.input.composing = !1), (t.input.compositionEndedAt = _g()));
...
function Vg(t) {
    ...
    let n = Hm(e.focusNode, e.focusOffset),
        r = $m(e.focusNode, e.focusOffset);
    if (n && r && n != r) {
        let o = r.pmViewDesc,
...
var fr = (Ee && Lt < 15) || (An && Wm < 604);
Ce.copy = ve.cut = (t, e) => {
    let n = e,
        r = t.state.selection,
        o = n.type == "cut";
    if (r.empty) return;
    let i = fr ? null : n.clipboardData,
        s = r.content(),
        { dom: l, text: a } = sl(t, s);
    (i
        ? (n.preventDefault(),
...
function Ug(t, e) {
    ...
    setTimeout(() => {
        (t.focus(),
            ...
            n
                ? hr(t, r.value, null, o, e)
                : hr(t, r.textContent, r.innerHTML, o, e));
    }, 50);
}
function hr(t, e, n, r, o) {
    let i = ll(t, e, n, r, t.state.selection.$from);
    if (t.someProp("handlePaste", (a) => a(t, o, i || N.empty))) return !0;
    if (!i) return !1;
    let s = jg(i),
        l = s
...
ve.paste = (t, e) => {
    ...
    let r = fr ? null : n.clipboardData,
        o = t.input.shiftKey && t.input.lastKeyCode != 45;
    r && hr(t, iu(r), r.getData("text/html"), o, n)
        ? n.preventDefault()
        : Ug(t, n);
};
var mo = class {
...
Ce.dragstart = (t, e) => {
    ...
    let o = t.state.selection,
        i = o.empty ? null : t.posAtCoords(xo(n)),
        s;
    if (
        !(i && i.pos >= o.from && i.pos <= (o instanceof I ? o.to - 1 : o.to))
    ) {
        if (r && r.mightDrag) s = I.create(t.state.doc, r.mightDrag.pos);
        else if (n.target && n.target.nodeType == 1) {
            let u = t.docView.nearestDesc(n.target, !0);
            u &&
                u.node.type.spec.draggable &&
                u != t.docView &&
                (s = I.create(t.state.doc, u.posBefore));
        }
    }
    let l = (s || t.state.selection).content(),
        { dom: a, text: c, slice: d } = sl(t, l);
    ((!n.dataTransfer.files.length || !ue || Ld > 120) &&
        n.dataTransfer.clearData(),
        n.dataTransfer.setData(fr ? "Text" : "text/html", a.innerHTML),
        (n.dataTransfer.effectAllowed = "copyMove"),
        fr || n.dataTransfer.setData("text/plain", c),
        (t.dragging = new mo(d, su(t, n), s)));
};
Ce.dragend = (t) => {
    let e = t.dragging;
    window.setTimeout(() => {
...
function qg(t, e, n) {
    ...
    i
        ...
        : (i = ll(
              t,
              iu(e.dataTransfer),
              fr ? null : e.dataTransfer.getData("text/html"),
              !1,
              o,
          ));
    let s = !!(n && su(t, e));
    if (t.someProp("handleDrop", (h) => h(t, e, i || N.empty, s))) {
        e.preventDefault();
        return;
    }
    if (!i) return;
    e.preventDefault();
    let l = i ? ro(t.state.doc, o.pos, i) : o.pos;
    l == null && (l = o.pos);
    let a = t.state.tr;
    if (s) {
        let { node: h } = n;
    ...
    if (
        ...
        (a.mapping.maps[a.mapping.maps.length - 1].forEach(
            ...
            a.setSelection(il(t, f, a.doc.resolve(h))));
    }
    ...
    if (ue && yt && e.inputType == "deleteContentBackward") {
        ...
        setTimeout(() => {
            if (
                ...
                (t.dom.blur(),
                t.focus(),
                t.someProp("handleKeyDown", (i) => i(t, Gt(8, "Backspace"))))
            )
                return;
...
var go = class t {
            ...
            return (
                ...
                (e instanceof t &&
                    ((this.spec.key && this.spec.key == e.spec.key) ||
                        (this.toDOM == e.toDOM && pr(this.spec, e.spec))))
            );
        }
        destroy(e) {
    ...
    ne = class t {
        ...
        static widget(e, n, r) {
            return new t(e, e, new go(n, r));
        }
        static inline(e, n, r, o) {
            return new t(e, n, new Qt(r, o));
        }
        static node(e, n, r, o) {
            return new t(e, n, new el(r, o));
        }
        get spec() {
    ...
    Q = class t {
        ...
        static create(e, n) {
            return n.length ? bo(n, e, 0, Zt) : we;
        }
        find(e, n, r) {
            let o = [];
        ...
        addInner(e, n, r) {
            ...
            return new t(
                s.length ? this.local.concat(s).sort(en) : this.local,
                o || this.children,
            );
        }
        remove(e) {
        ...
        forChild(e, n) {
            ...
            for (let l = 0; l < this.local.length; l++) {
                let a = this.local[l];
                if (a.from < s && a.to > i && a.type instanceof Qt) {
            ...
            if (o) {
                let l = new t(o.sort(en), vn);
                return r ? new yo([l, r]) : l;
            }
            return r || we;
        }
        eq(e) {
...
var we = Q.empty,
    yo = class t {
        ...
        map(e, n) {
            let r = this.members.map((o) => o.map(e, n, Zt));
            return t.from(r);
        }
        forChild(e, n) {
            if (n.isLeaf) return Q.empty;
            let r = [];
        ...
        static from(e) {
            switch (e.length) {
                ...
                default:
                    return new t(
                        e.every((n) => n instanceof Q)
                            ? e
                            : e.reduce(
                                  (n, r) =>
                                      n.concat(r instanceof Q ? r : r.members),
                                  [],
                              ),
                    );
            }
            ...
            for (let o = n + 1; o < e.length; o++) {
                ...
                if (i.from == r.from) {
                    i.to != r.to &&
                        ...
                        Cd(e, o + 1, i.copy(r.to, i.to)));
                    continue;
                } else {
                    i.from < r.to &&
                        (e == t && (e = t.slice()),
                        (e[n] = r.copy(r.from, i.from)),
                        Cd(e, o, r.copy(i.from, r.to)));
                    break;
                }
            }
    }
...
function zs(t) {
    ...
    return (
        ...
        t.cursorWrapper &&
            e.push(Q.create(t.state.doc, [t.cursorWrapper.deco])),
        yo.from(e)
    );
}
var Xg = {
    ...
    nl = class {
        ...
        start() {
            (this.observer &&
                ...
                this.observer.observe(this.view.dom, Xg)),
                this.onCharData &&
        ...
        ignoreSelectionChange(e) {
            ...
            let n = new Set(),
                r;
            for (let i = e.focusNode; i; i = Tn(i)) n.add(i);
            for (let i = e.anchorNode; i; i = Tn(i))
                if (n.has(i)) {
                    r = i;
                    break;
                }
        ...
        flush() {
            ...
            wo(r) &&
            (c = ol(e)) &&
            c.eq(L.near(e.state.doc.resolve(0), 1))
                ? ((e.input.lastFocus = 0),
                  bt(e),
                  this.currentSelection.set(r),
                  e.scrollToSelection())
                : (i > -1 || o) &&
                  (i > -1 && (e.docView.markDirty(i, s), Qg(e)),
                  this.handleDOMChange(i, s, l, a),
                  e.docView && e.docView.dirty
                      ? e.updateState(e.state)
                      : this.currentSelection.eq(r) || bt(e),
                  this.currentSelection.set(r));
        }
        registerMutation(e, n) {
            ...
            if (e.type == "childList") {
                ...
                let s = o && o.parentNode == e.target ? he(o) + 1 : 0,
...
function Qg(t) {
    if (
        ...
        if (((t.requiresGeckoHackNode = He), Md)) return;
        (console.warn(
...
function Td(t, e) {
    ...
    return (
        tn(s.node, s.offset, o, i) && ([n, r, o, i] = [o, i, n, r]),
...
function ty(t, e, n) {
    ...
    if (
        (d &&
            ...
            wo(a) || c.push({ node: a.focusNode, offset: a.focusOffset })),
...
function oy(t, e, n, r, o) {
    ...
    if (((t.input.compositionPendingChanges = 0), e < 0)) {
        ...
        if (E && !t.state.selection.eq(E)) {
            if (
                ...
                t.someProp("handleKeyDown", (A) => A(t, Gt(13, "Enter")))
            )
                return;
            let M = t.state.tr.setSelection(E);
            (k == "pointer"
                ? M.setMeta("pointer", !0)
                : k == "key" && M.scrollIntoView(),
    ...
    let p = ly(u.content, c.doc.content, c.from, f, h);
    if (
        (p && t.input.domChangeCount++,
        ((An && t.input.lastIOSEnter > Date.now() - 225) || yt) &&
            o.some((k) => k.nodeType == 1 && !ry.test(k.nodeName)) &&
            (!p || p.endA >= p.endB) &&
            t.someProp("handleKeyDown", (k) => k(t, Gt(13, "Enter"))))
    ) {
        t.input.lastIOSEnter = 0;
        return;
    }
    if (!p)
        if (
            ...
            if (c.sel) {
                let k = Ad(t, t.state.doc, c.sel);
                if (k && !k.eq(t.state.selection)) {
                    let E = t.state.tr.setSelection(k);
    ...
    if (
        ...
        sy(d, p.start, p.endA, m, g) &&
        t.someProp("handleKeyDown", (k) => k(t, Gt(8, "Backspace")))
    ) {
                ...
                M &&
                    !(
                        (ue &&
                            ...
                            (M.head == w || M.head == E.mapping.map(C) - 1)) ||
                        (Ee && M.empty && M.head == w)
                    ) &&
                    E.setSelection(M);
            }
    ...
    if (b)
        if (m.pos == g.pos) {
            Ee &&
                ...
                setTimeout(() => bt(t), 20));
            let k = x(t.state.tr.delete(w, C)),
                E = d.resolve(p.start).marksAcross(d.resolve(p.endA));
            (E && k.ensureMarks(E), t.dispatch(k));
        } else if (
            p.endA == p.endB &&
            (S = iy(
            ...
            let k = x(t.state.tr);
            (S.type == "add"
                ? k.addMark(w, C, S.mark)
                : k.removeMark(w, C, S.mark),
                t.dispatch(k));
        } else if (
            ...
            let k = m.parent.textBetween(m.parentOffset, g.parentOffset),
                E = () => x(t.state.tr.insertText(k, w, C));
            t.someProp("handleTextInput", (M) => M(t, w, C, k, E)) ||
                t.dispatch(E());
        } else t.dispatch(x());
    else t.dispatch(x());
}
function Ad(t, e, n) {
    return Math.max(n.anchor, n.head) > e.content.size
        ? null
        : il(t, e.resolve(n.anchor), e.resolve(n.head));
}
function iy(t, e) {
...
function sy(t, e, n, r, o) {
    if (n - e <= o.pos - r.pos || Hs(r, !0, !1) < o.pos) return !1;
    let i = t.resolve(e);
    if (!r.parent.isTextblock) {
        let l = i.nodeAfter;
    ...
    if (i.parentOffset < i.parent.content.size || !i.parent.isTextblock)
        return !1;
    let s = t.resolve(Hs(i, !0, !0));
    return !s.parent.isTextblock || s.pos > n || Hs(s, !0, !1) < n
        ? !1
    ...
    Nn = class {
        constructor(e, n) {
            ((this._root = null),
                ...
                (this.domObserver = new nl(this, (r, o, i, s) =>
                    oy(this, r, o, i, s),
                )),
        ...
        update(e) {
            ...
            ((this._props = e),
                e.plugins &&
                    (e.plugins.forEach(Id), (this.directPlugins = e.plugins)),
        ...
        updateStateInner(e, n) {
            ...
            let o = this.state,
                i = !1,
                s = !1;
            (e.storedMarks && this.composing && (ou(this), (s = !0)),
                (this.state = e));
            ...
            if (
                ...
                let h = Dd(this);
                uy(h, this.nodeViews) && ((this.nodeViews = h), (i = !0));
            }
            ...
            if (s) {
                ...
                let h =
                    ...
                    !o.selection.empty &&
                    !e.selection.empty &&
                    dy(o.selection, e.selection);
                if (u) {
                    let p = ue
                        ? (this.trackWrites =
                              this.domSelectionRange().focusNode)
                        : null;
                    (this.composing && (this.input.compositionNode = Vg(this)),
                        (i || !this.docView.update(e.doc, c, a, this)) &&
                            (this.docView.updateOuterDeco(c),
                            this.docView.destroy(),
                            (this.docView = cd(e.doc, c, a, this.dom, this))),
            ...
            if (
                ...
                if (!this.someProp("handleScrollToSelection", (n) => n(this)))
                    if (this.state.selection instanceof I) {
                        ...
                        n.nodeType == 1 &&
                            rd(this, n.getBoundingClientRect(), e);
                    } else
                        rd(
                            this,
        ...
        updateDraggedNode(e, n) {
            ...
            this.dragging = new mo(
                e.slice,
                e.move,
                o < 0 ? void 0 : I.create(this.state.doc, o),
            );
        }
        someProp(e, n) {
        ...
        endOfTextblock(e, n) {
            return og(this, n || this.state, e);
        }
        pasteHTML(e, n) {
            return hr(this, "", e, !1, n || new ClipboardEvent("paste"));
        }
        pasteText(e, n) {
            return hr(this, e, null, !0, n || new ClipboardEvent("paste"));
        }
        ...
        destroy() {
            this.docView &&
                ...
                this.destroyPluginViews(),
                this.mounted
                    ? (this.docView.update(this.state.doc, [], zs(this), this),
        ...
        domSelectionRange() {
            ...
            return e
                ? (xe &&
                      ...
                      Vm(this.dom.ownerDocument) == this.dom &&
                      Zg(this, e)) ||
                      e
                : {
                      focusNode: null,
...
var wt = {
    ...
    fy = typeof navigator < "u" && /Mac/.test(navigator.platform),
    hy =
        typeof navigator < "u" &&
        /MSIE \d|Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(
            navigator.userAgent,
        );
for (ae = 0; ae < 10; ae++) wt[48 + ae] = wt[96 + ae] = String(ae);
var ae;
for (ae = 1; ae <= 24; ae++) wt[ae + 111] = "F" + ae;
var ae;
for (ae = 65; ae <= 90; ae++)
    ((wt[ae] = String.fromCharCode(ae + 32)),
        (So[ae] = String.fromCharCode(ae)));
var ae;
for (ko in wt) So.hasOwnProperty(ko) || (So[ko] = wt[ko]);
var ko;
function du(t) {
    var e =
            (fy && t.metaKey && t.shiftKey && !t.ctrlKey && !t.altKey) ||
            (hy && t.shiftKey && t.key && t.key.length == 1) ||
            t.key == "Unidentified",
        n =
            (!e && t.key) ||
            (t.shiftKey ? So : wt)[t.keyCode] ||
            t.key ||
            "Unidentified";
    return (
        n == "Esc" && (n = "Escape"),
...
var py =
    ...
    my = typeof navigator < "u" && /Win/.test(navigator.platform);
function gy(t) {
    let e = t.split(/-(?!$)/),
        n = e[e.length - 1];
    n == "Space" && (n = " ");
    ...
    for (let l = 0; l < e.length - 1; l++) {
        ...
        else if (/^mod$/i.test(a)) py ? (s = !0) : (o = !0);
...
function uu(t) {
    return new P({ props: { handleKeyDown: yr(t) } });
}
function yr(t) {
    let e = yy(t);
    return function (n, r) {
...
var by = Object.defineProperty,
    xl = (t, e) => {
        for (var n in e) by(t, n, { get: e[n], enumerable: !0 });
    };
function Sr(t) {
        ...
        buildProps(t, e = !0) {
            let { rawCommands: n, editor: r, state: o } = this,
                ...
                s = {
                    ...
                    editor: r,
                    view: i,
                    state: Sr({ state: o, transaction: t }),
                    dispatch: e ? () => {} : void 0,
...
xl(kl, {
    ...
    scrollIntoView: () => Zy,
    selectAll: () => eb,
    selectNodeBackward: () => tb,
    selectNodeForward: () => nb,
    selectParentNode: () => rb,
    selectTextblockEnd: () => ob,
...
function No(t, e, n) {
    ...
    let s = o.index,
        ...
        a = s + 1,
        c = l + o.node.nodeSize;
    for (; s > 0 && fu([...t.parent.child(s - 1).marks], e, n); )
        ((s -= 1), (l -= t.parent.child(s).nodeSize));
    for (; a < t.parent.childCount && fu([...t.parent.child(a).marks], e, n); )
...
function rt(t = 0, e = 0, n = 0) {
    return Math.min(Math.max(t, e), n);
}
function Sl(t, e = null) {
    if (!e) return null;
    let n = L.atStart(t),
        r = L.atEnd(t);
    ...
    let o = n.from,
        i = r.to;
    return e === "all"
        ? D.create(t, rt(0, o, i), rt(t.content.size, o, i))
        : D.create(t, rt(e, o, i), rt(e, o, i));
}
function Oo() {
    return (
...
var Iy =
        ...
        ({ editor: n, view: r, tr: o, dispatch: i }) => {
            ...
            if (i && t === null && !vr(n.state.selection)) return (s(), !0);
            let l = Sl(o.doc, t) || n.state.selection,
    ...
    Py = (t, e) => (n) => t.every((r, o) => e(r, { ...n, index: o })),
    Ly =
        (t, e) =>
        ({ tr: n, commands: r }) =>
            r.insertContentAt(
...
function Dn(t, e, n) {
    ...
    if (o) {
        if (n.errorOnInvalidContent) {
            ...
            if (
                (n.slice
                    ? Ae.fromSchema(a).parseSlice(Rn(t), n.parseOptions)
                    : Ae.fromSchema(a).parse(Rn(t), n.parseOptions),
        ...
        return n.slice
            ? i.parseSlice(Rn(t), n.parseOptions).content
            : i.parse(Rn(t), n.parseOptions);
    }
    return Dn("", e, n);
}
function bu(t, e, n) {
...
var By = (t) => !("type" in t),
            ...
            if (o) {
                ...
                if (f) {
                    ...
                    let g = r.doc.resolve(d),
                        ...
                        C = y.content.size > 0;
                    (b && w && C && (d = Math.max(0, d - 1)),
                        r.replaceWith(d, u, m));
                }
                (n.updateSelection && bu(r, r.steps.length - 1, -1),
                    n.applyInputRules &&
    ...
    _y =
        ...
        ({ state: t, dispatch: e, tr: n }) => {
            try {
                let r = Kt(t.doc, t.selection.$from.pos, -1);
...
function Ky(t) {
    ...
    for (let l = 0; l < e.length - 1; l += 1) {
        ...
        else if (/^mod$/i.test(a)) In() || Cl() ? (s = !0) : (o = !0);
        else throw new Error(`Unrecognized modifier name: ${a}`);
    }
    return (
        r && (n = `Alt-${n}`),
...
function Ke(t, e, n = {}) {
    ...
    let a = o - r,
        c = l
            ...
            .filter((u) => xr(u.node.attrs, n, { strict: !1 }));
...
var Qy =
        ...
        ({ tr: n, state: r, dispatch: o }) => {
            let i = null,
                s = null,
                l = Mr(typeof t == "string" ? t : t.name, r.schema);
            if (!l) return !1;
            (l === "node" && (i = re(t, r.schema)),
                l === "mark" && (s = ot(t, r.schema)));
            let a = !1;
            return (
                n.selection.ranges.forEach((c) => {
                    r.doc.nodesBetween(c.$from.pos, c.$to.pos, (d, u) => {
                        (i &&
                            i === d.type &&
                            ((a = !0),
                            o && n.setNodeMarkup(u, void 0, gl(d.attrs, e))),
                            s &&
                                d.marks.length &&
                                d.marks.forEach((f) => {
                                    s === f.type &&
...
function Tr(t, e) {
    let n = et.fromSchema(e).serializeFragment(t),
...
function J(t, e = void 0, ...n) {
    return Tl(t) ? (e ? t.bind(e)(...n) : t(...n)) : t;
}
function wu(t = {}) {
            ...
            o.map((c) => {
                let d = r.filter((y) => y.type === c.name),
                    ...
                    h = hu({
                        ...
                        attrs: Object.fromEntries(d.map(pu)),
                    }),
                    p = J(B(c, "parseHTML", u));
                p && (h.parseDOM = p.map((y) => yl(y, d)));
                let m = B(c, "renderHTML", u);
                m &&
                    (h.toDOM = (y) => m({ node: y, HTMLAttributes: kr(y, d) }));
        ...
        a = Object.fromEntries(
            i.map((c) => {
                let d = r.filter((g) => g.type === c.name),
                    ...
                    p = J(B(c, "parseHTML", u));
                p && (h.parseDOM = p.map((g) => yl(g, d)));
                let m = B(c, "renderHTML", u);
                return (
                    m &&
                        (h.toDOM = (g) =>
                            m({ mark: g, HTMLAttributes: kr(g, d) })),
                    [c.name, h]
                );
            }),
        );
    return new Ut({ topNode: s, nodes: l, marks: a });
}
function ku(t) {
...
`,
        ...
        i = Bo(e),
        s = te.fromJSON(i, t);
    return Ol(s, { blockSeparator: r, textSerializers: { ...zo(i), ...o } });
}
function Su(t, e) {
    let n = re(e, t.schema),
...
function Ho(t, e) {
    let n = Mr(typeof e == "string" ? e : e.name, t.schema);
    return n === "node" ? Su(t, e) : n === "mark" ? vl(t, e) : {};
}
function Cu(t, e = JSON.stringify) {
    let n = {};
    return t.filter((r) => {
        let o = e(r);
...
function vu(t, e = 0) {
    ...
    return (
        ...
        t.content.childCount &&
            ...
            t.forEach((c, d) => {
                var u;
                (u = a.content) == null || u.push(vu(c, e + d + r));
            })),
...
function Ao(t, e, n = {}) {
    ...
    let a = l
            ...
            .filter((u) => xr(u.mark.attrs, n, { strict: !1 }))
...
function Fo(t, e, n = {}) {
    if (!e) return Ke(t, null, n) || Ao(t, null, n);
    let r = Mr(e, t.schema);
    return r === "node" ? Ke(t, e, n) : r === "mark" ? Ao(t, e, n) : !1;
}
var Dl = (t, e) => {
...
function Ln(t, { checkChildren: e = !0, ignoreWhitespace: n = !1 } = {}) {
    ...
    if (e) {
        ...
        return (
            t.content.forEach((i) => {
                o !== !1 &&
                    (Ln(i, { ignoreWhitespace: n, checkChildren: e }) ||
                        (o = !1));
            }),
            o
        );
...
function Au(t, e) {
    ...
    return { position: new Pl(n.pos), mapResult: n };
}
function Eu(t) {
    return new Pl(t);
}
...
var xb =
        ...
        ({ tr: e, state: n, dispatch: r, editor: o }) => {
            let { selection: i, doc: s } = e,
                ...
                d = wr(c, l.node().type.name, l.node().attrs);
            if (i instanceof I && i.node.isBlock)
                return !l.parentOffset || !Re(s, l.pos)
                    ? !1
                    : (r &&
                          (t && mu(n, o.extensionManager.splittableMarks),
            ...
            let u = a.parentOffset === a.parent.content.size,
                f =
                    l.depth === 0
                        ? void 0
                        : Pn(l.node(-1).contentMatchAt(l.indexAfter(-1))),
        ...
        ({ tr: n, state: r, dispatch: o, editor: i }) => {
            ...
            if (
                ...
                if (o) {
                    ...
                    let w =
                            a.indexAfter(-1) < a.node(-2).childCount
                                ...
                                : a.indexAfter(-2) < a.node(-3).childCount
                                  ...
                                  : 3,
                        C = {
                            ...wr(f, a.node().type.name, a.node().attrs),
                            ...e,
                        },
                        x =
                    ...
                    n.replace(S, a.after(-w), new N(y, 4 - b, 0));
                    let k = -1;
                    (n.doc.nodesBetween(S, n.doc.content.size, (E, M) => {
                        if (k > -1) return !1;
                        E.isTextblock && E.content.size === 0 && (k = M + 1);
                    }),
            ...
            let h = c.pos === a.end() ? u.contentMatchAt(0).defaultType : null,
                p = { ...wr(f, u.type.name, u.attrs), ...e },
                m = { ...wr(f, a.node().type.name, a.node().attrs), ...e };
            ...
            if (o) {
                ...
                if ((n.split(a.pos, 2, g).scrollIntoView(), !C || !o))
                    return !0;
                let x = C.filter((S) => w.includes(S.type.name));
                n.ensureMarks(x);
            }
            return !0;
        },
    pl = (t, e) => {
        ...
        return (
            n.node.type === o?.type && Le(t.doc, n.pos) && t.join(n.pos),
            !0
        );
    },
    ml = (t, e) => {
                ...
                : a()
                      .command(() => {
                          let S = d().wrapInList(h, r),
                              k = C.filter((E) => f.includes(E.type.name));
...
function Co(t) {
    ...
    return (
        s.forEach((f) => {
            ...
            if (!h) return;
            let p = a.state.tr,
                m = Sr({ state: a.state, transaction: p }),
                g = { from: r - (h[0].length - i.length), to: o },
                {
                    commands: y,
                    chain: b,
                    can: w,
                } = new Cr({ editor: n, state: m });
            f.handler({
                state: m,
                range: g,
                match: h,
    ...
    return (
        br(t) &&
            ...
            Object.keys(e).forEach((r) => {
                br(e[r]) && br(t[r]) ? (n[r] = Bl(t[r], e[r])) : (n[r] = e[r]);
            }),
        n
    );
}
...
function zb(t) {
    let {
        ...
        { commands: a, chain: c, can: d } = new Cr({ editor: e, state: n }),
        u = [];
    return (
        n.doc.nodesBetween(r, o, (h, p) => {
            ...
            Bb(k, i.find, s).forEach((M) => {
                if (M.index === void 0) return;
                let A = x + M.index + 1,
                    z = A + M[0].length,
                    j = { from: n.tr.mapping.map(A), to: n.tr.mapping.map(z) },
                    V = i.handler({
                        state: n,
                        range: j,
                        match: M,
        ...
        (d) =>
            new P({
                ...
                appendTransaction: (u, f, h) => {
                    ...
                    let w = f.doc.content.findDiffStart(h.doc.content),
...
var Wo = class {
    constructor(t, e) {
        ((this.splittableMarks = []),
            ...
            (this.extensions = Lo(t)),
            (this.schema = El(this.extensions, e)),
    ...
    get plugins() {
        let { editor: t } = this;
        return Po([...this.extensions].reverse()).flatMap((r) => {
            let o = {
                    name: r.name,
                    options: r.options,
                    storage: this.editor.extensionStorage[r.name],
                    editor: t,
                    type: Mo(r.name, this.schema),
                },
                i = [],
            ...
            if (bl(r, t.options.enableInputRules) && c) {
                let f = c();
                if (f && f.length) {
                    let h = Ou({ editor: t, rules: f }),
                        p = Array.isArray(h) ? h : [h];
                    i.push(...p);
                }
            }
            let d = B(r, "addPasteRules", o);
            if (bl(r, t.options.enablePasteRules) && d) {
                let f = d();
                if (f && f.length) {
                    let h = Iu({ editor: t, rules: f });
                    i.push(...h);
                }
            }
                ...
                new P({
                    ...
                    appendTransaction: (t, e, n) => {
                        ...
                        let { empty: i, from: s, to: l } = e.selection,
                            a = L.atStart(e.doc).from,
                            c = L.atEnd(e.doc).to;
                        if (i || !(s === a && l === c) || !Ln(n.doc)) return;
                        let f = n.tr,
                            h = Sr({ state: n, transaction: f }),
                            { commands: p } = new Cr({
                                editor: this.editor,
                                state: h,
                            });
        ...
        get children() {
            ...
            return (
                this.node.content.forEach((n, r) => {
                    ...
                    let a = new On(l, this.editor, o, o ? n : null);
                    (o && (a.actualDepth = this.depth + 1),
                        e.push(new On(l, this.editor, o, o ? n : null)));
                }),
                e
            );
        }
...
var Fb = class extends Ib {
    constructor(t = {}) {
        ...
        let e = this.createDoc(),
            n = Sl(e, this.options.autofocus);
        ((this.editorState = lr.create({
            doc: e,
            schema: this.schema,
            selection: n || void 0,
        })),
    ...
    injectCSS() {
        this.options.injectCSS &&
            typeof document < "u" &&
            (this.css = Ju($b, this.options.injectNonce));
    }
    setOptions(t = {}) {
    ...
    createExtensionManager() {
        ...
        let r = [
            ...(this.options.enableCoreExtensions
                ? [
                      ...
                      ju,
                      Hu,
                      Ku.configure({ direction: this.options.textDirection }),
                  ].filter((o) =>
        ...
        this.extensionManager = new Wo(r, this);
    }
    createCommandManager() {
        this.commandManager = new Cr({ editor: this });
    }
    createSchema() {
    ...
    getAttributes(t) {
        return Ho(this.state, t);
    }
    isActive(t, e) {
        let n = typeof t == "string" ? t : null,
            r = typeof t == "string" ? e : t;
        return Fo(this.state, n, r);
    }
    getJSON() {
        return this.state.doc.toJSON();
    }
    getHTML() {
        return Tr(this.state.doc.content, this.schema);
    }
    getText(t) {
        let {
            blockSeparator: e = `
...
`,
        ...
        return Ol(this.state.doc, {
            blockSeparator: e,
            textSerializers: { ...zo(this.schema), ...n },
        });
    }
    get isEmpty() {
                ...
                for (k.lastIndex = 0; ; ) {
                    ...
                    if (!((p = M[2]) != null && p.endsWith(":::"))) {
                        if (z) C += 1;
                            ...
                            let j = E.slice(0, A);
                            S = j.trim();
                            let V = u.slice(0, x + A + M[0].length),
                                _ = [];
                            if (S)
                                if (l === "block")
                                    for (
...
function Yu(t) {
    let {
            ...
            name: n,
            getContent: r,
            parseAttributes: o = qb,
            serializeAttributes: i = Jb,
            defaultAttributes: s = {},
            selfClosing: l = !1,
            allowedAttributes: a,
        } = t,
...
`),
        ...
        let b,
            w = y.slice(1);
        if (w.length > 0) {
            let x = w.map((S) => S.slice(m + u)).join(`
`);
            x.trim() &&
    ...
    Xb = class {
        ...
        onDragStart(t) {
            ...
            let u = 0,
                f = 0;
            if (this.dom !== d) {
                let b = this.dom.getBoundingClientRect(),
                    ...
                    x =
                        (s = t.offsetY) != null
                            ...
                            : (i = t.nativeEvent) == null
                              ? void 0
                              : i.offsetY;
                ((u = w.x - b.x + C), (f = w.y - b.y + x));
            }
            let h = this.dom.cloneNode(!0);
            try {
                let b = this.dom.getBoundingClientRect();
                ((h.style.width = `${Math.round(b.width)}px`),
                    (h.style.height = `${Math.round(b.height)}px`),
        ...
        stopEvent(t) {
            ...
            if (
                ...
                return !0;
            let { isEditable: l } = this.editor,
                { isDragging: a } = this,
                c = !!this.node.type.spec.draggable,
                d = I.isSelectable(this.node),
                u = t.type === "copy",
                f = t.type === "paste",
                h = t.type === "cut",
                p = t.type === "mousedown";
            if (
                (!c && d && o && t.target === this.dom && t.preventDefault(),
                c && o && !a && t.target === this.dom)
            )
                return (t.preventDefault(), !1);
            if (c && l && !a && p) {
                let m = n.closest("[data-drag-handle]");
                m &&
        ...
        updateAttributes(t) {
            this.editor.commands.command(({ tr: e }) => {
                ...
                return typeof n != "number"
                    ? !1
                    : (e.setNodeMarkup(n, void 0, { ...this.node.attrs, ...t }),
                      !0);
            });
        }
        deleteNode() {
...
function Yb(t) {
    return new _o({
        ...
        handler({ match: e, chain: n, range: r, pasteEvent: o }) {
            ...
            (s && (l.content = s),
                e.input && n().deleteRange(r).insertContentAt(r.from, l));
        },
    });
}
function Qb(t) {
...
var ce = class t extends L {
    constructor(e) {
        super(e, e);
    }
    map(e, n) {
        let r = e.resolve(n.map(this.head));
        return t.valid(r) ? new t(r) : L.near(r);
    }
    content() {
        return N.empty;
    }
    ...
    getBookmark() {
        return new Vl(this.anchor);
    }
    static valid(e) {
        let n = e.parent;
        if (n.isTextblock || !e0(e) || !t0(e)) return !1;
...
var Vl = class t {
    ...
    resolve(e) {
        ...
        return ce.valid(n) ? new ce(n) : L.near(n);
    }
};
function ef(t) {
...
function e0(t) {
    for (let e = t.depth; e >= 0; e--) {
        ...
        for (let o = r.child(n - 1); ; o = o.lastChild) {
            if ((o.childCount == 0 && !o.inlineContent) || ef(o.type))
                return !0;
...
function r0(t, e, n) {
    ...
    return o && o.inside > -1 && I.isSelectable(t.state.doc.nodeAt(o.inside))
        ? !1
...
function o0(t, e) {
    ...
    let i = t.state.tr.replace(n.pos, n.pos, new N(o, 0, 0));
    return (
...
function i0(t) {
    ...
    return (
        ...
        Q.create(t.doc, [ne.widget(t.selection.head, e, { key: "gapcursor" })])
    );
}
var Go = 200,
    pe = function () {};
pe.prototype.append = function (e) {
    return e.length
        ? ((e = pe.from(e)),
          (!this.length && e) ||
              (e.length < Go && this.leafAppend(e)) ||
              (this.length < Go && e.leafPrepend(this)) ||
              this.appendInner(e))
        : this;
};
...
pe.from = function (e) {
    return e instanceof pe ? e : e && e.length ? new nf(e) : pe.empty;
};
var nf = (function (t) {
    function e(r) {
    ...
    ln = class t {
        ...
        addMaps(e) {
            return this.eventCount == 0
                ? this
                : new t(
                      this.items.append(e.map((n) => new it(n))),
                      this.eventCount,
                  );
        }
        rebased(e, n) {
            ...
            let c = [];
            for (let f = n; f < s; f++) c.push(new it(i.maps[f]));
        ...
        compress(e = this.items.length) {
            ...
            return (
                ...
                new t(_l.from(o.reverse()), i)
            );
        }
    };
ln.empty = new ln(_l.empty, 0);
function a0(t, e) {
    let n;
    return (
        t.forEach((r, o) => {
...
function d0(t, e, n, r) {
    ...
    n.getMeta(h0) && (t = new st(t.done, t.undone, null, 0, -1));
    let s = n.getMeta("appendedTransaction");
    if (n.steps.length == 0) return t;
    if (s && s.getMeta(sn))
        return s.getMeta(sn).redo
            ? new st(
                  t.done.addTransform(n, void 0, r, Xo(e)),
                  t.undone,
                  rf(n.mapping.maps),
                  t.prevTime,
                  t.prevComposition,
            ...
            : new st(
                  t.done,
                  t.undone.addTransform(n, void 0, r, Xo(e)),
                  null,
                  t.prevTime,
                  t.prevComposition,
              );
            ...
            a =
                ...
                (!s &&
                    ...
                    (t.prevTime < (n.time || 0) - r.newGroupDelay ||
                        !u0(n, t.prevRanges))),
            c = s ? Wl(t.prevRanges, n.mapping) : rf(n.mapping.maps);
        return new st(
            t.done.addTransform(
                n,
...
function f0(t, e, n) {
    ...
    let s = i.selection.resolve(i.transform.doc),
        ...
        a = new st(n ? l : i.remaining, n ? i.remaining : l, null, 0, -1);
    return i.transform
        .setSelection(s)
        .setMeta(sn, { redo: n, historyState: a });
}
var jl = !1,
    of = null;
function Xo(t) {
...
var sn = new H("history"),
    h0 = new H("closeHistory");
function sf(t = {}) {
    return (
        ...
        new P({
            ...
            state: {
                init() {
                    return new st(ln.empty, ln.empty, null, 0, -1);
                },
                apply(e, n, r) {
                    return d0(n, r, e, t);
                },
...
`)
        ...
        addInputRules() {
            return [Je({ find: p0, type: this.type })];
        },
    }),
    uf = m0;
var g0 = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))$/,
    y0 = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))/g,
    b0 = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))$/,
    w0 = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))/g,
    x0 = ee.create({
        name: "bold",
        addOptions() {
            return { HTMLAttributes: {} };
        ...
        addInputRules() {
            return [
                De({ find: g0, type: this.type }),
                De({ find: b0, type: this.type }),
            ];
        },
        addPasteRules() {
            return [
                Me({ find: y0, type: this.type }),
                Me({ find: w0, type: this.type }),
            ];
        },
    }),
    ff = x0;
var k0 = /(^|[^`])`([^`]+)`(?!`)$/,
    ...
    C0 = ee.create({
        ...
        addInputRules() {
            return [De({ find: k0, type: this.type })];
        },
        addPasteRules() {
        ...
        addKeyboardShortcuts() {
            return {
                ...
                Tab: ({ editor: t }) => {
                    ...
                    let n = (e = this.options.tabSize) != null ? e : Jl,
                        { state: r } = t,
                        { selection: o } = r,
                        { $from: i, empty: s } = o;
                ...
                ArrowDown: ({ editor: t }) => {
                    ...
                    return l === void 0
                        ...
                        : r.nodeAt(l)
                          ? t.commands.command(
                                ({ tr: c }) => (
                                    c.setSelection(L.near(r.resolve(l))),
                                    !0
                                ),
                            )
                          : t.commands.exitCode();
...
var mf = $.create({
    ...
    addNodeView() {
        return ({
            ...
            if (e.attrs.preview) {
                ...
                (e.attrs.shouldApplyProseStylingToPreview ||
                    d.push("fi-not-prose"),
                    (c.className = d.join(" ")),
    ...
    addAttributes() {
        return {
            config: {
                ...
                renderHTML: (t) =>
                    t.config ? { "data-config": JSON.stringify(t.config) } : {},
            },
            id: {
                default: null,
    ...
    renderHTML({ HTMLAttributes: t }) {
        return ["div", O({ "data-type": "customBlock" }, t)];
    },
    addKeyboardShortcuts() {
        return {
            Backspace: () =>
...
var Qo = (t, e) => e.view.domAtPos(t).node.offsetParent !== null,
    A0 = (t, e, n) => {
    ...
    gf = (t, e) => {
        ...
        if (!d) return !1;
        let u = on(d.node, (y) => y.type === i.nodes.detailsContent);
        if (!u.length || Qo(d.start + u[0].pos + 1, t)) return !1;
    ...
    yf = $.create({
        ...
        addKeyboardShortcuts() {
            return {
                ...
                ArrowRight: ({ editor: t }) => gf(t, "right"),
                ArrowDown: ({ editor: t }) => gf(t, "down"),
            };
        },
        addProseMirrorPlugins() {
            return [
                new P({
                    ...
                    appendTransaction: (t, e, n) => {
                        ...
                        if (Qo(a.pos, r)) return;
                        let d = A0(a, (y) => y.type === o, r);
                        if (!d) return;
                        let u = on(
                            d.node,
            ...
            return {
                Enter: ({ editor: t }) => {
                    ...
                    let b = o.indexAfter(-3),
                        w = Pn(y.contentMatchAt(b));
                    if (!w || !y.canReplaceWith(b, b, w)) return !1;
                    let C = w.createAndFill();
                    if (!C) return !1;
                    let { tr: x } = e,
                        S = o.after(-2);
                    x.replaceWith(S, S, C);
...
var R0 = /(?:^|\s)(==(?!\s+==)((?:[^=]+))==(?!\s+==))$/,
    ...
    I0 = ee.create({
        ...
        addInputRules() {
            return [De({ find: R0, type: this.type })];
        },
        addPasteRules() {
            return [Me({ find: D0, type: this.type })];
        },
    }),
    Mf = I0;
var P0 = $.create({
        ...
        addCommands() {
            return {
                setHorizontalRule:
                    () =>
                    ({ chain: t, state: e }) => {
                        if (!zl(e, e.schema.nodes[this.name])) return !1;
                        let { selection: n } = e,
                            { $to: r } = n,
                            o = t();
                        return (
        ...
        addInputRules() {
            return [
                Nr({ find: /^(?:---|—-|___\s|\*\*\*\s)$/, type: this.type }),
            ];
        },
    }),
    Tf = P0;
var L0 = /(?:^|\s)(\*(?!\s+\*)((?:[^*]+))\*(?!\s+\*))$/,
    ...
    $0 = ee.create({
        ...
        addInputRules() {
            return [
                De({ find: L0, type: this.type }),
                De({ find: z0, type: this.type }),
            ];
        },
        addPasteRules() {
            return [
                Me({ find: B0, type: this.type }),
                Me({ find: H0, type: this.type }),
            ];
        },
    }),
    Af = $0;
...
Ne.prototype = {
    ...
    tr(t, e, n, r) {
        ...
        let o;
        return (
            e && e.j ? (o = e) : ((o = new Ne(e)), n && r && an(e, n, r)),
            this.jr.push([t, o]),
            o
        );
    },
        ...
        if (
            ...
            if (r)
                if (s.t && typeof s.t == "string") {
                    let a = Object.assign(q0(s.t, r), n);
                    an(i, a, r);
                } else n && an(i, n, r);
            s.t = i;
        }
...
var U = (t, e, n, r, o) => t.ta(e, n, r, o),
    ...
    ci = "FULLWIDTHLEFTPAREN",
    di = "FULLWIDTHRIGHTPAREN",
    ui = "LEFTCORNERBRACKET",
    fi = "RIGHTCORNERBRACKET",
    hi = "LEFTWHITECORNERBRACKET",
    pi = "RIGHTWHITECORNERBRACKET",
    mi = "FULLWIDTHLESSTHAN",
    ...
    _f = Object.freeze({
        ...
        EQUALS: vi,
        EXCLAMATION: fa,
        FULLWIDTHGREATERTHAN: gi,
        FULLWIDTHLEFTPAREN: ci,
        FULLWIDTHLESSTHAN: mi,
        FULLWIDTHMIDDLEDOT: Ff,
        FULLWIDTHRIGHTPAREN: di,
        HYPHEN: Ve,
...
function X0(t = []) {
    ...
    (Zo == null && (Zo = If(_0)),
        ...
        T(n, "\\", xi),
        T(n, "\u30FB", Ff));
    let r = ie(n, kt, ca, { [ta]: !0 });
    ie(r, kt, r);
    let o = ie(r, xt, Hf, { [Ir]: !0 }),
        i = ie(r, Rr, $f, { [Dr]: !0 }),
        s = ie(n, xt, St, { [na]: !0 });
    (ie(s, kt, o), ie(s, xt, s), ie(o, kt, o), ie(o, xt, o));
    let l = ie(n, Rr, ia, { [ra]: !0 });
    (ie(l, xt),
        ie(l, kt, i),
        ie(l, Rr, l),
        ie(i, kt, i),
    ...
    (T(n, Zl, d),
        ...
        ie(d, Yl, d),
        T(d, Zl, d));
    let u = ie(n, Xl, Vf, { [zf]: !0 });
    (T(u, "#"), ie(u, Xl, u), T(u, J0, u));
    let f = T(u, G0);
    (T(f, "#"), ie(f, Xl, u));
    let h = [
            [xt, s],
    ...
    for (let m = 0; m < Zo.length; m++) $t(n, Zo[m], sa, St, h);
    for (let m = 0; m < ei.length; m++) $t(n, ei[m], la, ia, p);
    (an(sa, { tld: !0, ascii: !0 }, e),
        an(la, { utld: !0, alpha: !0 }, e),
        $t(n, "file", ni, St, h),
        $t(n, "mailto", ni, St, h),
        $t(n, "http", Fn, St, h),
        $t(n, "https", Fn, St, h),
        $t(n, "ftp", Fn, St, h),
        $t(n, "ftps", Fn, St, h),
        an(ni, { scheme: !0, ascii: !0 }, e),
        an(Fn, { slashscheme: !0, ascii: !0 }, e),
    ...
    return (
        Rf(n, "localhost", $r, { ascii: !0 }),
        (n.jd = new Ne(Ni)),
        { start: n, tokens: Object.assign({ groups: e }, _f) }
    );
}
function Wf(t, e) {
    let n = Y0(e.replace(/[A-Z]/g, (l) => l.toLowerCase())),
        r = n.length,
        o = [],
        i = 0,
        s = 0;
...
function $t(t, e, n, r, o) {
    ...
    for (let l = 0; l < s - 1; l++) {
        ...
        (t.j[a]
            ? (i = t.j[a])
            : ((i = new Ne(r)), (i.jr = o.slice()), (t.j[a] = i)),
            (t = i));
    }
...
var Lf = Oi("email", {
    ...
    ti = Oi("url", {
        isLink: !0,
        toHref(t = Fr.defaultProtocol) {
            return this.hasProtocol() ? this.v : `${t}://${this.v}`;
        },
        hasProtocol() {
            let t = this.tk;
            return t.length >= 2 && t[0].t !== $r && t[1].t === Vt;
        },
    });
var Fe = (t) => new Ne(t);
function Z0({ groups: t }) {
    ...
    U(f, t.domain, u);
    let h = Fe(Lf);
    (U(f, t.tld, h), U(f, t.utld, h), T(c, $r, h));
    let p = T(u, Ve);
    (T(p, Ve, p),
        U(p, t.domain, u),
        U(h, t.domain, u),
    ...
    let g = T(s, Ve),
        y = T(s, lt);
    (T(g, Ve, g), U(g, t.domain, s), U(y, r, i), U(y, t.domain, s));
    let b = Fe(ti);
    (U(y, t.tld, b),
        U(y, t.utld, b),
        U(b, t.domain, s),
    ...
    let x = Fe(ti),
        S = Fe();
    (U(x, e, x), U(x, n, S), U(S, e, x), U(S, n, S), T(b, at, x), T(C, at, x));
    let k = T(l, Vt),
        E = T(a, Vt),
        M = T(E, at),
        A = T(M, at);
    ...
    return (T(o, $r, b), T(o, da, Q0), { start: o, tokens: _f });
}
function ew(t, e, n) {
    let r = n.length,
        o = 0,
    ...
    return (s.length > 0 && i.push(ea(Bf, e, s)), i);
}
function ea(t, e, n) {
    let r = n[0].s,
        o = n[n.length - 1].e,
...
var tw = (typeof console < "u" && console && console.warn) || (() => {}),
    nw =
...
function ga(t, e = !1) {
    if (
        (Z.initialized &&
            tw(
                `linkifyjs: already initialized - will not register custom scheme "${t}" ${nw}`,
            ),
...
function Ri(t) {
    return (
        Z.initialized || rw(),
        ew(Z.parser.start, t, Wf(Z.scanner.start, t))
    );
}
Ri.scan = Wf;
function Di(t, e = null, n = null) {
    ...
    return new P({
        ...
        appendTransaction: (e, n, r) => {
            ...
            let { tr: s } = r,
                l = Ro(n.doc, [...e]);
            if (
                ($o(l).forEach(({ newRange: c }) => {
                    let d = Ml(r.doc, c, (h) => h.isTextblock),
                        u,
                        f;
                    if (d.length > 1)
                        ((u = d[0]),
                    ...
                    if (u && f) {
                        let h = f.split(ow).filter(Boolean);
    ...
    return new P({
        ...
        props: {
            handlePaste: (e, n, r) => {
                ...
                let c = Di(a, { defaultProtocol: t.defaultProtocol }).find(
...
var uw = ee.create({
        ...
        addOptions() {
            return {
                ...
                isAllowedUri: (t, e) => !!cn(t, e.protocols),
                validate: (t) => !!t,
                shouldAutoLink: (t) => !!t,
            };
        },
...
var fw = Object.defineProperty,
    hw = (t, e) => {
        for (var n in e) fw(t, n, { get: e[n], enumerable: !0 });
    },
    pw = "listItem",
    qf = "textStyle",
    Jf = /^\s*([-+*])\s$/,
...
`,
        ...
        addInputRules() {
            let t = Je({ find: Jf, type: this.type });
            return (
...
var Vr = (t, e) => {
    ...
    ba = (t, e, n) => {
        ...
        if (!Ke(t.state, e) && Qf(t.state, e, n)) {
        ...
        if (!Ke(t.state, e) || !Il(t.state)) return !1;
        let r = Vr(e, t.state);
        if (!r) return !1;
        let i = t.state.doc.resolve(r.$pos.pos - 2).node(r.depth),
            s = eh(e, t.state, i);
        return Zf(e, t.state) && !s
    ...
    wa = (t, e) => {
        if (!Ke(t.state, e) || !Dl(t.state, e)) return !1;
        ...
        addExtensions() {
            ...
            return (
                this.options.bulletList !== !1 &&
                    t.push(xa.configure(this.options.bulletList)),
                this.options.listItem !== !1 &&
                    t.push(ka.configure(this.options.listItem)),
                this.options.listKeymap !== !1 &&
                    t.push(yw.configure(this.options.listKeymap)),
                this.options.orderedList !== !1 &&
                    t.push(Ca.configure(this.options.orderedList)),
                this.options.taskItem !== !1 &&
                    t.push(Cw.configure(this.options.taskItem)),
                this.options.taskList !== !1 &&
                    t.push(vw.configure(this.options.taskList)),
                t
            );
        },
    });
var Vn = (t, e, n = {}) => {
        ...
        return new P({
            ...
            props: {
                handleDrop(d, u) {
                    ...
                    (Vn(d, "form-processing-started", { message: a }),
                        u.preventDefault(),
                        u.stopPropagation());
                ...
                handlePaste(d, u) {
                    let f = u.clipboardData?.files?.length
                            ? Array.from(u.clipboardData.files)
                            : [],
                    ...
                    if (p) {
                        ...
                        if (y.length) {
                            u.stopPropagation();
                            let { from: b, to: w } = t.state.selection;
                            return (
                                Vn(d, "form-processing-started", {
                                    message: a,
                                }),
                                t.setEditable(!1),
                                d.dom.dispatchEvent(
                                ...
                                (async () => {
                                    for (let k of y) {
                                        ...
                                        try {
                                            let [R, F] = E.split(","),
                                                W = R.match(/:(.*?);/)[1],
                                                X = atob(F),
                                                oe = new Uint8Array(X.length);
                                            for (
                                                let Se = 0;
                                                Se < X.length;
                                                Se++
                                            )
                                                oe[Se] = X.charCodeAt(Se);
                                            M = new Blob([oe], { type: W });
                                        } catch {
                                            continue;
                                        }
                                        let A =
                                        ...
                                        if (
                                            ...
                                            continue;
                                        let V = Ma(),
                                            _ = await new Promise((R) => {
                                                r().upload(
                                                    `componentFileAttachments.${l}.${V}`,
                                                    z,
                                                    () => {
                                                        c(V).then((F) =>
                                                            R(F ?? null),
                                        ...
                                        _ &&
                                            (k.setAttribute("src", _),
                                            k.setAttribute("data-id", V));
                                    }
                                    for (let k of Array.from(
                                        g.querySelectorAll("img[src]"),
                                    )) {
                                        let E = g.createElement("p");
                                        (k.replaceWith(E), E.appendChild(k));
                                    }
                                    let C = g.body.innerHTML;
                                    t.view.someProp(
                                        "transformPastedHTML",
                                        (k) => {
                                            C = k(C);
                                    ...
                                    let S = Ae.fromSchema(
                                        t.state.schema,
                                    ).parseSlice(x, { preserveWhitespace: !1 });
                                    (t.view.dispatch(
                                        t.state.tr.replaceRange(b, w, S),
                                    ),
                                        t.setEditable(!0),
                                        d.dom.dispatchEvent(
                                            new CustomEvent(
    ...
    oh = K.create({
        ...
        addProseMirrorPlugins() {
            return [Mw({ editor: this.editor, ...this.options })];
        },
    });
function Tw(t) {
    var e;
...
function Ew({
    ...
    let g,
        ...
        b = () => {
            let S = e.state.selection.$anchor.pos,
                ...
                { top: E, right: M, bottom: A, left: z } = k;
            try {
                return new DOMRect(z, E, M - z, A - E);
            } catch {
                return null;
            }
        },
        w = (S, k) =>
            k
                ? () => {
                      let E = t.getState(e.state),
                          M = E?.decorationId,
                          A = S.dom.querySelector(
                              `[data-decoration-id="${M}"]`,
                          );
    ...
    function C(S, k) {
        ...
        try {
            ...
            (E = y?.onExit) == null || E.call(y, j);
        } catch {}
        let M = S.state.tr.setMeta(k, { exit: !0 });
        S.dispatch(M);
    }
    let x = new P({
        key: t,
        view() {
            return {
                update: async (S, k) => {
                    var E, M, A, z, j, V, _;
                    let R = (E = this.key) == null ? void 0 : E.getState(k),
                        F =
                            (M = this.key) == null
                                ? void 0
                                : M.getState(S.state),
                        W =
                            R.active &&
                            F.active &&
                            R.range.from !== F.range.from,
                        X = !R.active && F.active,
                        oe = R.active && !F.active,
                        Se = !X && !oe && R.query !== F.query,
                        Tt = X || (W && Se),
                        q = Se || W,
                        Ze = oe || (W && Se);
                    if (!Tt && !q && !Ze) return;
                    let Te = Ze && !Tt ? R : F,
                        Ua = S.dom.querySelector(
                            `[data-decoration-id="${Te.decorationId}"]`,
                        );
                    ((g = {
                        editor: e,
                        range: Te.range,
                        ...
                        items: [],
                        command: (Bp) =>
                            u({ editor: e, range: Te.range, props: Bp }),
                        decorationNode: Ua,
                        clientRect: w(S, Ua),
                    }),
                        Tt && ((A = y?.onBeforeStart) == null || A.call(y, g)),
                        q && ((z = y?.onBeforeUpdate) == null || z.call(y, g)),
                        (q || Tt) &&
                            (g.items = await f({ editor: e, query: Te.query })),
                        Ze && ((j = y?.onExit) == null || j.call(y, g)),
                        q && ((V = y?.onUpdate) == null || V.call(y, g)),
                        Tt && ((_ = y?.onStart) == null || _.call(y, g)));
                },
                destroy: () => {
                    var S;
        ...
        state: {
            ...
            apply(S, k, E, M) {
                ...
                if (((R.composing = z), A && (V || e.view.composing))) {
        ...
        props: {
            handleKeyDown(S, k) {
                var E, M, A, z;
                let { active: j, range: V } = x.getState(S.state);
                if (!j) return !1;
                if (k.key === "Escape" || k.key === "Esc") {
                    let R = x.getState(S.state),
                        F = (E = g?.decorationNode) != null ? E : null,
                        W =
                            F ??
                            (R?.decorationId
                                ? S.dom.querySelector(
                    ...
                    let oe = {
                        ...
                        items: [],
                        command: (Se) =>
                            u({ editor: e, range: R.range, props: Se }),
                        decorationNode: W,
                        clientRect: W
                ...
                return (
                    ((z = y?.onKeyDown) == null
                        ? void 0
                        : z.call(y, { view: S, event: k, range: V })) || !1
                );
            },
            decorations(S) {
                let {
...
var Nw = function ({
    ...
    ih = $.create({
        ...
        addProseMirrorPlugins() {
            return [
                ...this.storage.suggestions.map(Ii),
                new P({
                    props: {
                        handleDrop(t, e) {
                            if (
...
var Ta = ["top", "right", "bottom", "left"],
    sh = ["start", "end"],
    Aa = Ta.reduce((t, e) => t.concat(e, e + "-" + sh[0], e + "-" + sh[1]), []),
    _e = Math.min,
    me = Math.max,
    jr = Math.round;
var Ge = (t) => ({ x: t, y: t }),
    Ow = { left: "right", right: "left", bottom: "top", top: "bottom" },
    Rw = { start: "end", end: "start" };
function Pi(t, e, n) {
    return me(t, _e(e, n));
}
function ct(t, e) {
...
var Dw = new Set(["top", "bottom"]);
function Xe(t) {
    return Dw.has(Ie(t)) ? "y" : "x";
}
function Bi(t) {
    return Ea(Xe(t));
}
        ...
        s =
            o === "x"
                ...
                : r === "start"
                  ? "bottom"
                  : "top";
    return (e.reference[i] > e.floating[i] && (s = Wr(s)), [s, Wr(s)]);
}
function ch(t) {
    let e = Wr(t);
    return [_r(t), e, _r(e)];
...
function _r(t) {
    return t.replace(/start|end/g, (e) => Rw[e]);
}
var lh = ["left", "right"],
    ah = ["right", "left"],
    Iw = ["top", "bottom"],
...
function dh(t, e, n, r) {
    let o = We(t),
        i = Lw(Ie(t), n === "start", r);
    return (
        o && ((i = i.map((s) => s + "-" + o)), e && (i = i.concat(i.map(_r)))),
        i
    );
}
function Wr(t) {
        ...
        x = Ct(
            i.convertOffsetParentRelativeRectToViewportRelativeRect
                ? await i.convertOffsetParentRelativeRectToViewportRelativeRect(
                      { elements: l, rect: b, offsetParent: w, strategy: a },
                  )
                : b,
        );
    return {
    ...
    async fn(e) {
        ...
        let E = C / 2 - x / 2,
            ...
            F =
                ...
                We(o) != null &&
                _ !== R &&
                i.reference[p] / 2 - (_ < j ? A : z) - m[p] / 2 < 0,
            W = F ? (_ < j ? _ - j : _ - V) : 0;
        return {
            [h]: f[h] + W,
            data: {
...
function zw(t, e, n) {
    return (
        t
            ...
            : n.filter((o) => Ie(o) === o)
    ).filter((o) => (t ? We(o) === t || (e ? _r(o) !== o : !1) : !0));
}
var gh = function (t) {
        return (
            t === void 0 && (t = {}),
                ...
                async fn(e) {
                    ...
                    let {
                        ...
                        } = e,
                        {
                            crossAxis: d = !1,
                            alignment: u,
                            allowedPlacements: f = Aa,
                            autoAlignment: h = !0,
                            ...p
                        } = ct(t, e),
                        m = u !== void 0 || f === Aa ? zw(u || null, h, f) : f,
                        g = await dn(e, p),
                        y =
                    ...
                    if (
                        ...
                        let F =
                            (j = A.filter((W) => W.overflows[0] <= 0).sort(
                                (W, X) => W.overflows[1] - X.overflows[1],
                            )[0]) == null
                                ? void 0
                                : j.placement;
                        if (!F)
...
var bh = function (t) {
    return (
        t === void 0 && (t = {}),
        {
            ...
            async fn(e) {
                let { rects: n } = e,
                    { strategy: r = "referenceHidden", ...o } = ct(t, e);
                switch (r) {
                    case "referenceHidden": {
                        ...
                        return {
                            data: {
                                ...
                                referenceHidden: hh(s),
                            },
                        };
                    }
                    case "escaped": {
                        let i = await dn(e, { ...o, altBoundary: !0 }),
                            s = fh(i, n.floating);
                        return { data: { escapedOffsets: s, escaped: hh(s) } };
                    }
                    default:
                        return {};
                }
...
function wh(t) {
    let e = _e(...t.map((i) => i.left)),
        n = _e(...t.map((i) => i.top)),
        r = me(...t.map((i) => i.right)),
        o = me(...t.map((i) => i.bottom));
                ...
                async fn(e) {
                    ...
                    function p() {
                        ...
                        if (u.length >= 2) {
                            ...
                            let g = Ie(n) === "left",
                                y = me(...u.map((A) => A.right)),
                                b = _e(...u.map((A) => A.left)),
                                w = u.filter((A) =>
                                    g ? A.left === b : A.right === y,
                                ),
                                C = w[0].top,
                                x = w[w.length - 1].bottom,
                                S = b,
                                k = y,
                                E = k - S,
                                M = x - C;
    ...
    return (
        t === void 0 && (t = {}),
        {
            ...
            async fn(e) {
                ...
                await a({ ...e, availableWidth: E, availableHeight: k });
                let M = await s.getDimensions(l.floating);
...
function Mh(t) {
    return $i() ? t instanceof Node || t instanceof Oe(t).Node : !1;
}
function je(t) {
    return $i() ? t instanceof Element || t instanceof Oe(t).Element : !1;
}
function Ye(t) {
    return $i()
        ? t instanceof HTMLElement || t instanceof Oe(t).HTMLElement
        : !1;
}
function vh(t) {
...
var Vw = new Set(["inline", "contents"]);
function _n(t) {
    let { overflow: e, overflowX: n, overflowY: r, display: o } = Ue(t);
    return /auto|scroll|overlay|hidden|clip/.test(e + r + n) && !Vw.has(o);
}
var _w = new Set(["table", "td", "th"]);
function Th(t) {
    return _w.has(un(t));
}
var Ww = [":popover-open", ":modal"];
function Ur(t) {
    return Ww.some((e) => {
        try {
            return t.matches(e);
...
var jw = ["transform", "translate", "scale", "rotate", "perspective"],
    Uw = ["transform", "translate", "scale", "rotate", "perspective", "filter"],
    Kw = ["paint", "layout", "strict", "content"];
function Fi(t) {
    let e = Vi(),
        n = je(t) ? Ue(t) : t;
    return (
        jw.some((r) => (n[r] ? n[r] !== "none" : !1)) ||
        (n.containerType ? n.containerType !== "normal" : !1) ||
        (!e && (n.backdropFilter ? n.backdropFilter !== "none" : !1)) ||
        (!e && (n.filter ? n.filter !== "none" : !1)) ||
        Uw.some((r) => (n.willChange || "").includes(r)) ||
        Kw.some((r) => (n.contain || "").includes(r))
    );
}
function Ah(t) {
    let e = vt(t);
...
var qw = new Set(["html", "body", "#document"]);
function fn(t) {
    return qw.has(un(t));
}
function Ue(t) {
...
function vt(t) {
    if (un(t) === "html") return t;
    let e = t.assignedSlot || t.parentNode || (vh(t) && t.host) || dt(t);
    return vh(e) ? e.host : e;
}
function Eh(t) {
    let e = vt(t);
    return fn(e)
...
function Wn(t) {
    ...
    let n = e.getBoundingClientRect(),
        { width: r, height: o, $: i } = Dh(e),
        s = (i ? jr(n.width) : n.width) / r,
        l = (i ? jr(n.height) : n.height) / o;
    return (
...
function qr(t, e, n, r) {
    ...
    let o = t.getBoundingClientRect(),
        i = Ih(t),
        s = Ge(1);
    e && (r ? je(r) && (s = Wn(r)) : (s = Wn(t)));
    let l = Gw(i, n, r) ? Ph(i) : Ge(0),
        a = (o.left + l.x) / s.x,
        c = (o.top + l.y) / s.y,
        d = o.width / s.x,
        u = o.height / s.y;
    if (i) {
        ...
        for (; m && r && h !== p; ) {
            let g = Wn(m),
                ...
                b = Ue(m),
                w = y.left + (m.clientLeft + parseFloat(b.paddingLeft)) * g.x,
...
function Wi(t, e) {
    let n = Kr(t).scrollLeft;
    return e ? e.left + n : qr(dt(t)).left + n;
}
function Lh(t, e) {
    let n = t.getBoundingClientRect(),
        r = n.left + e.scrollLeft - Wi(t, n),
        o = n.top + e.scrollTop;
    return { x: r, y: o };
}
function Xw(t) {
    ...
    if (
        (u || (!u && !i)) &&
        ((un(r) !== "body" || _n(s)) && (a = Kr(r)), Ye(r))
    ) {
        let h = qr(r);
        ((c = Wn(r)), (d.x = h.x + r.clientLeft), (d.y = h.y + r.clientTop));
    }
    let f = s && !u && !i ? Lh(s, a) : Ge(0);
    return {
        width: n.width * c.x,
        height: n.height * c.y,
...
function Qw(t) {
    let e = dt(t),
        ...
        o = me(e.scrollWidth, e.clientWidth, r.scrollWidth, r.clientWidth),
        i = me(e.scrollHeight, e.clientHeight, r.scrollHeight, r.clientHeight),
        s = -n.scrollLeft + Wi(t),
        l = -n.scrollTop;
    return (
        Ue(r).direction === "rtl" &&
            (s += me(e.clientWidth, r.clientWidth) - o),
...
var ex = new Set(["absolute", "fixed"]);
function tx(t, e) {
    let n = qr(t, !0, e === "fixed"),
        r = n.top + t.clientTop,
...
function Oh(t, e, n) {
    let r;
    if (e === "viewport") r = Zw(t, n);
    else if (e === "document") r = Qw(dt(t));
    else if (je(e)) r = tx(e, n);
    else {
        let o = Ph(t);
...
function Bh(t, e) {
    let n = vt(t);
    return n === e || !je(n) || fn(n)
        ? !1
        : Ue(n).position === "fixed" || Bh(n, e);
}
function nx(t, e) {
    let n = e.get(t);
    if (n) return n;
    let r = Hi(t, [], !1).filter((l) => je(l) && un(l) !== "body"),
        o = null,
    ...
    let { element: e, boundary: n, rootBoundary: r, strategy: o } = t,
        ...
        a = s.reduce(
            (c, d) => {
                let u = Oh(e, d, o);
                return (
                    (c.top = me(u.top, c.top)),
                    (c.right = _e(u.right, c.right)),
                    (c.bottom = _e(u.bottom, c.bottom)),
                    (c.left = me(u.left, c.left)),
                    c
                );
            },
            Oh(e, l, o),
...
function ix(t, e, n) {
    ...
    if (r || (!r && !i))
        if (((un(e) !== "body" || _n(o)) && (l = Kr(e)), r)) {
            let h = qr(e, !0, i, e);
            ((a.x = h.x + e.clientLeft), (a.y = h.y + e.clientTop));
        } else o && c();
    i && !r && o && c();
    let d = o && !r && !i ? Lh(o, l) : Ge(0),
...
function Rh(t, e) {
    if (!Ye(t) || Ue(t).position === "fixed") return null;
    if (e) return e(t);
...
function zh(t, e) {
    ...
    if (!Ye(t)) {
        let o = vt(t);
        for (; o && !fn(o); ) {
            if (je(o) && !Oa(o)) return o;
            o = vt(o);
        }
        return n;
    }
    let r = Rh(t, e);
    for (; r && Th(r) && Oa(r); ) r = Rh(r, e);
    return r && fn(r) && Oa(r) && !Fi(r) ? n : r || Ah(t) || n;
}
var sx = async function (t) {
    let e = this.getOffsetParent || zh,
        n = this.getDimensions,
        r = await n(t.floating);
    return {
        reference: ix(t.reference, await e(t.floating), t.strategy),
            ...
            render: () => {
                ...
                let u = () => {
                        ...
                        return (
                            ...
                            (w.style.maxHeight = "15rem"),
                            (w.style.minWidth = "12rem"),
                            w
                        );
                    },
                    f = () => {
                        if (!l || !c) return;
                        let w = Array.isArray(c.items) ? c.items : [],
                            C = c.query ?? "";
                        if (((l.innerHTML = ""), d)) {
                            let x = o ?? "Searching...",
                                S = document.createElement("div");
                                ...
                                let k =
                                        typeof x == "string"
                                            ...
                                            : (x?.label ??
                                              x?.name ??
                                              String(x?.id ?? "")),
                                    E = typeof x == "object" ? (x?.id ?? k) : k,
                                    M = document.createElement("button");
                                ((M.className = `fi-dropdown-list-item ${S === a ? "fi-selected" : ""}`),
                                    (M.type = "button"),
                                    M.addEventListener("click", () => p(E, k)));
                    ...
                    g = () => {
                        ...
                        let w = Array.isArray(c.items) ? c.items : [];
                        w.length !== 0 &&
                            ((a = (a + w.length - 1) % w.length), f(), m());
                    },
                    y = () => {
                        if (!c) return;
                        let w = c.items || [];
                        w.length !== 0 && ((a = (a + 1) % w.length), f(), m());
                    },
                    b = () => {
                        let w = c?.items || [];
                                ...
                                return m.filter((y) => {
                                    let b =
                                        typeof y == "string"
                                            ? y
                                            : (y?.label ?? y?.name ?? "");
                                    return String(b).toLowerCase().includes(g);
                                });
                            },
                            isSearchable: l,
                            noOptionsMessage: i,
...
var ux = /(?:^|\s)(~~(?!\s+~~)((?:[^~]+))~~(?!\s+~~))$/,
    ...
    hx = ee.create({
        ...
        addInputRules() {
            return [De({ find: ux, type: this.type })];
        },
        addPasteRules() {
            return [Me({ find: fx, type: this.type })];
        },
    }),
    Xh = hx;
var px = ee.create({
...
if (typeof WeakMap < "u") {
    let t = new WeakMap();
    ((Ia = (e) => t.get(e)), (Pa = (e, n) => (t.set(e, n), n)));
} else {
    let t = [],
        n = 0;
    ((Ia = (r) => {
...
function Cx(t, e, n) {
    let r = ke(e.type.schema).header_cell;
    for (let o = 0; o < t.height; o++)
        if (e.nodeAt(t.map[n + o * t.width]).type != r) return !1;
    return !0;
}
var Y = class Mt extends L {
    constructor(e, n = e) {
        let r = e.node(-1),
            o = se.get(r),
            i = e.start(-1),
        ...
        let c = a.map((d) => {
            ...
            let f = i + d + 1;
            return new Jt(l.resolve(f), l.resolve(f + u.content.size));
        });
    ...
    replace(e, n = N.empty) {
        ...
        for (let s = 0; s < o.length; s++) {
            let { $from: l, $to: a } = o[s],
                c = e.mapping.slice(r);
            e.replace(c.map(l.pos), c.map(a.pos), s ? N.empty : n);
        }
        let i = L.findFrom(e.doc.resolve(e.mapping.slice(r).map(this.to)), -1);
        i && e.setSelection(i);
    }
    replaceWith(e, n) {
        this.replace(e, new N(v.from(n), 0, 0));
    }
    forEachCell(e) {
    ...
    getBookmark() {
        return new vx(this.$anchorCell.pos, this.$headCell.pos);
    }
};
...
function $a(t, e) {
    ...
    return (
        e ? e.doc != t.doc && up(e.doc, t.doc, 0, r) : t.doc.descendants(r),
        n
    );
}
function Ox(t, e, n, r) {
    ...
    for (let a = 0, c = n + 1; a < o.height; a++) {
        ...
        if (f > 0) {
            ...
            let p = [];
            for (let g = 0; g < f; g++) {
                let y = ke(t.schema)[h].createAndFill();
                y && p.push(y);
            }
    ...
    return r.setMeta(Nx, { fixTables: !0 });
}
function ut(t) {
    let e = t.selection,
        n = Gi(t),
...
function fp(t, { map: e, tableStart: n, table: r }, o) {
    let i = o > 0 ? -1 : 0;
    Cx(e, r, o + i) && (i = o == 0 || o == e.width ? null : 0);
    for (let s = 0; s < e.height; s++) {
        ...
        if (o > 0 && o < e.width && e.map[l - 1] == e.map[l]) {
            ...
            (t.setNodeMarkup(
                t.mapping.map(n + a),
                null,
                cp(c.attrs, o - e.colCount(a)),
            ),
                (s += c.attrs.rowspan - 1));
        } else {
            let a =
                    i == null
                        ? ke(r.type.schema).cell
...
function Rx(t, { map: e, table: n, tableStart: r }, o) {
...
function mp(t, e) {
    ...
    if (e) {
        ...
        for (let o = n.right - 1; Rx(r, n, o), o != n.left; o--) {
...
function Dx(t, e, n) {
    var r;
    let o = ke(e.type.schema).header_cell;
...
function gp(t, { map: e, tableStart: n, table: r }, o) {
    let i = n;
    for (let c = 0; c < o; c++) i += r.child(c).nodeSize;
    let s = [],
        l = o > 0 ? -1 : 0;
    Dx(e, r, o + l) && (l = o == 0 || o == e.height ? null : 0);
    ...
    return (t.insert(i, ke(r.type.schema).row.create(null, s)), t);
}
function yp(t, e) {
    if (!Qe(t)) return !1;
    if (e) {
...
function wp(t, e) {
    ...
    if (e) {
        ...
        for (let o = n.bottom - 1; Ix(r, n, o), o != n.top; o--) {
            let i = n.tableStart ? r.doc.nodeAt(n.tableStart - 1) : r.doc;
            if (!i) throw new RangeError("No table found");
...
function Px({ width: t, height: e, map: n }, r) {
...
function Va(t, e) {
    let n = ke(t.schema);
    return Lx(({ node: r }) => n[r.type.spec.tableRole])(t, e);
}
function Lx(t) {
    return (e, n) => {
        let r = e.selection,
        ...
        if (r instanceof Y) {
            ...
            var s;
            if (((o = xx(r.$from)), !o)) return !1;
            i = (s = hn(r.$from)) === null || s === void 0 ? void 0 : s.pos;
        }
        if (
            o == null ||
            i == null ||
...
var HM = qn("row", { useDeprecatedLogic: !0 }),
    $M = qn("column", { useDeprecatedLogic: !0 }),
    kp = qn("cell", { useDeprecatedLogic: !0 });
function zx(t, e) {
    if (e < 0) {
        let n = t.nodeBefore;
...
function _a(t) {
    return function (e, n) {
        ...
        if (n) {
            ...
            n(e.tr.setSelection(D.between(o, Sx(o))).scrollIntoView());
        }
        return !0;
    };
}
...
function ji(t, e) {
    ...
    if (e) {
        let r = t.tr,
            o = ke(t.schema).cell.createAndFill().content;
        (n.forEachCell((i, s) => {
            i.content.eq(o) ||
                r.replace(
                    r.mapping.map(s + 1),
...
function Hx(t) {
    ...
    if (i == "row")
        for (let a = 0; a < e.childCount; a++) {
            ...
            ((d || u) && (c = Ba(ke(s).row, new N(c, d, u)).content),
                l.push(c));
        }
    else if (i == "cell" || i == "header_cell")
        l.push(n || r ? Ba(ke(s).row, new N(e, n, r)).content : e);
    else return null;
    return $x(s, l);
}
function $x(t, e) {
...
function Fx({ width: t, height: e, rows: n }, r, o) {
    if (t != r) {
        let i = [],
            s = [];
            ...
            for (let d = i[l] || 0, u = 0; d < r; u++) {
                ...
                (d + f.attrs.colspan > r &&
                    (f = f.type.createChecked(
                        pn(f.attrs, f.attrs.colspan, d + f.attrs.colspan - r),
                        f.content,
                    )),
                    c.push(f),
                    (d += f.attrs.colspan));
    ...
    for (let c = o; c < i; c++) {
        ...
        if (e.map[d - 1] == u) {
            ...
            (t.setNodeMarkup(
                p,
                null,
                pn(f.attrs, s - h, f.attrs.colspan - (s - h)),
            ),
                t.insert(
                    p + f.nodeSize,
                    f.type.createAndFill(pn(f.attrs, 0, s - h)),
                ),
                (c += f.attrs.rowspan - 1));
        }
    }
...
function rp(t, e, n, r, o) {
    ...
    (Vx(u, s, i, n, c, d, f) && h(),
        tp(u, s, i, n, a, c, l, f) && h(),
        tp(u, s, i, n, a, c, d, f) && h(),
        np(u, s, i, n, l, d, a, f) && h(),
        np(u, s, i, n, l, d, c, f) && h());
    for (let p = l; p < d; p++) {
...
var _x = yr({
    ...
    ArrowUp: Ui("vert", -1),
    ArrowDown: Ui("vert", 1),
    "Shift-ArrowLeft": Ki("horiz", -1),
    "Shift-ArrowRight": Ki("horiz", 1),
    "Shift-ArrowUp": Ki("vert", -1),
    "Shift-ArrowDown": Ki("vert", 1),
    Backspace: ji,
    "Mod-Backspace": ji,
    Delete: ji,
    "Mod-Delete": ji,
...
function Ui(t, e) {
    return (n, r, o) => {
        if (!o) return !1;
        let i = n.selection;
        if (i instanceof Y) return qi(n, r, L.near(i.$headCell, e));
        if (t != "horiz" && !i.empty) return !1;
        let s = Cp(o, t, e);
        if (s == null) return !1;
        if (t == "horiz") return qi(n, r, L.near(n.doc.resolve(i.head + e), e));
        {
            ...
            return (
                a
                    ? (c = L.near(a, 1))
                    : e < 0
                      ? (c = L.near(n.doc.resolve(l.before(-1)), -1))
                      : (c = L.near(n.doc.resolve(l.after(-1)), 1)),
                qi(n, r, c)
            );
        }
    };
...
function Ki(t, e) {
    return (n, r, o) => {
        ...
        let l = ap(s.$headCell, t, e);
        return l ? qi(n, r, new Y(s.$anchorCell, l)) : !1;
    };
}
function Wx(t, e) {
    let n = t.state.doc,
    ...
    if (o instanceof Y) {
        r ||
            (r = {
                width: 1,
                height: 1,
                rows: [v.from(Ba(ke(t.state.schema).cell, n))],
            });
        ...
        return (
            (r = Fx(r, l.right - l.left, l.bottom - l.top)),
            rp(t.state, t.dispatch, s, l, r),
            !0
        );
    } else if (r) {
        let i = Gi(t.state),
        ...
        return (
            rp(
                ...
                t.dispatch,
                s,
                se.get(i.node(-1)).findCell(i.pos - s),
                r,
            ),
            !0
        );
...
function Ux(t, e) {
    ...
    if (e.shiftKey && t.state.selection instanceof Y)
        ...
        e.shiftKey &&
        r &&
        (o = hn(t.state.selection.$anchor)) != null &&
        ((n = Da(t, e)) === null || n === void 0 ? void 0 : n.pos) != o.pos
    )
    ...
    function l(a) {
        ...
        else if (op(t, c.target) != r && ((u = Da(t, e)), !u)) return s();
        u && i(u, c);
    }
...
function Da(t, e) {
    ...
    return (r >= 0 && hn(t.state.doc.resolve(r))) || hn(t.state.doc.resolve(o));
}
var Kx = class {
    constructor(t, e) {
        ((this.node = t),
            ...
            za(t, this.colgroup, this.table, e),
    ...
    update(t) {
        return t.type != this.node.type
            ? !1
            : ((this.node = t),
              za(t, this.colgroup, this.table, this.defaultCellMinWidth),
              !0);
    }
    ignoreMutation(t) {
        return (
...
var Pe = new H("tableColumnResizing");
function vp({
    handleWidth: t = 5,
    cellMinWidth: e = 25,
    ...
    let i = new P({
        ...
        props: {
            ...
            decorations: (s) => {
                let l = Pe.getState(s);
                if (l && l.activeHandle > -1) return tk(s, l.activeHandle);
            },
            nodeViews: {},
        },
    });
...
var qx = class Ji {
    ...
    apply(e) {
        let n = this,
            r = e.getMeta(Pe);
        if (r && r.setHandle != null) return new Ji(r.setHandle, !1);
        if (r && r.setDragging !== void 0)
            return new Ji(n.activeHandle, r.setDragging);
        if (n.activeHandle > -1 && e.docChanged) {
            let o = e.mapping.map(n.activeHandle, -1);
            return (La(e.doc.resolve(o)) || (o = -1), new Ji(o, n.dragging));
        }
        return n;
    }
};
function Jx(t, e, n, r) {
    ...
    if (o && !o.dragging) {
        ...
        if (i) {
            ...
            e.clientX - l <= n
                ? (s = ip(t, e, "left", n))
                : a - e.clientX <= n && (s = ip(t, e, "right", n));
        }
        if (s != o.activeHandle) {
            if (!r && s !== -1) {
...
function Gx(t) {
    ...
    e && e.activeHandle > -1 && !e.dragging && Mp(t, -1);
}
function Xx(t, e, n, r) {
    var o;
    ...
    let l = t.state.doc.nodeAt(s.activeHandle),
        a = Yx(t, s.activeHandle, l.attrs);
    t.dispatch(
        t.state.tr.setMeta(Pe, {
    ...
    function c(u) {
        ...
        f?.dragging &&
            (Zx(t, f.activeHandle, sp(f.dragging, u, n)),
    ...
    function d(u) {
        ...
        let f = Pe.getState(t.state);
        if (f && f.dragging) {
            let h = sp(f.dragging, u, n);
            lp(t, f.activeHandle, h, r);
        }
    }
    return (
        lp(t, s.activeHandle, a, r),
...
function Yx(t, e, { colspan: n, colwidth: r }) {
...
function Zx(t, e, n) {
    ...
    for (let c = 0; c < i.height; c++) {
        ...
        let p = f.colwidth ? f.colwidth.slice() : ek(f.colspan);
...
function Tp({ allowTableNodeSelection: t = !1 } = {}) {
    return new P({
        key: _t,
        state: {
            init() {
            ...
            for (let g = 0; g < p; g += 1, h += 1) {
                ...
                if (((l += y || r), y || (a = !1), c)) {
                    ...
                    let w = document.createElement("col"),
                        [C, x] = Wa(r, y);
                    (w.style.setProperty(C, x), e.appendChild(w));
                }
            }
        }
    for (; c; ) {
...
var ik = class {
    constructor(t, e) {
        ((this.node = t),
            ...
            Ap(t, this.colgroup, this.table, e),
            (this.contentDOM = this.table.appendChild(
                document.createElement("tbody"),
            )));
    }
    update(t) {
        return t.type !== this.node.type
            ? !1
            : ((this.node = t),
              Ap(t, this.colgroup, this.table, this.cellMinWidth),
              !0);
    }
    ignoreMutation(t) {
        let e = t.target,
...
var Xi = ({ editor: t }) => {
        ...
        if (!ck(e)) return !1;
        let n = 0,
            r = Do(e.ranges[0].$from, (i) => i.type.name === "table");
        return (
...
function fk(t, e, n = {}) {
    var r;
    let o = (r = n.cellLineSeparator) != null ? r : dk;
    ...
    pk = $.create({
        ...
        renderHTML({ node: t, HTMLAttributes: e }) {
            let {
                    ...
                    tableWidth: r,
                    tableMinWidth: o,
                } = sk(t, this.options.cellMinWidth),
                i = e.style;
            function s() {
            ...
            let l = [
                "table",
                O(this.options.HTMLAttributes, e, { style: s() }),
                n,
                ["tbody", 0],
            ];
        ...
        addExtensions() {
            ...
            return (
                this.options.table !== !1 &&
                    t.push(pk.configure(this.options.table)),
                this.options.tableCell !== !1 &&
                    t.push(nk.configure(this.options.tableCell)),
                this.options.tableHeader !== !1 &&
                    t.push(rk.configure(this.options.tableHeader)),
                this.options.tableRow !== !1 &&
                    t.push(ok.configure(this.options.tableRow)),
                t
            );
        },
    });
...
var Ip = (t, e) => {
    ...
    Pp = ({ mergeTags: t, noMergeTagSearchResultsMessage: e }) => ({
        items: ({ query: n }) =>
            Object.entries(t)
                .filter(
                    ([r, o]) =>
...
var Lp = async ({
    ...
    let k = [
            ...
            bf,
            xf,
            af.configure({ class: "fi-not-prose" }),
            cf,
            kf,
            Sf,
            Cf,
            ...
            Ca,
            qh,
            Ra.configure({ placeholder: w }),
            Gh.configure({ textColors: x }),
            Jh,
            Xh,
            Yh,
            Qh,
            Np.configure({ table: { resizable: !0 } }),
            Op,
            Rp.configure({
        ...
        E = await Promise.all(
            o.map(async (M) => {
                new RegExp("^(?:[a-z+]+:)?//", "i").test(M) ||
                    (M = new URL(M, document.baseURI).href);
                try {
                    let z = (await import(M)).default;
                    return typeof z == "function" ? z() : z;
                } catch (z) {
                    return (
                        console.error(
                            `Failed to load rich editor custom extension from [${M}]:`,
                            z,
                        ),
                        null
                    );
    ...
    for (let M of E) {
        ...
        let A = k.findIndex((z) => z.name === M.name);
        (M.name === "placeholder" &&
            M.parent === null &&
            (M = Ra.configure(M.options)),
            A !== -1 ? (k[A] = M) : k.push(M));
    }
    return k;
};
            ...
            ((this.preventHide = !1),
                ...
                (this.shouldShow = ({ view: d, state: u, from: f, to: h }) => {
                    let { doc: p, selection: m } = u,
                        { empty: g } = m,
                        y = !p.textBetween(f, h).length && vr(u.selection),
        ...
        get middlewares() {
            ...
            return (
                ...
                this.floatingUIOptions.arrow &&
                    t.push(_h(this.floatingUIOptions.arrow)),
            ...
            let { selection: e } = this.editor.state,
                n =
                    (t = this.getReferencedVirtualElement) == null
                        ...
                        : t.call(this);
            if (n) return n;
            let r = Ll(this.view, e.from, e.to),
                o = {
...
function Sk({
    ...
    livewireId: g,
    maxFileSize: y,
    maxFileSizeValidationMessage: b,
    mergeTags: w,
    mentions: C,
    getMentionSearchResultsUsing: x,
    getMentionLabelsUsing: S,
    noMergeTagSearchResultsMessage: k,
    placeholder: E,
    state: M,
    statePath: A,
    textColors: z,
    ...
    return {
        ...
        async init() {
            V = new xk({
                ...
                extensions: await Lp({
                    ...
                    floatingToolbars: l,
                    hasResizableImages: a,
                    insertCustomBlockUsing: (q, Ze = null) =>
                        this.$wire.mountAction(
                            "customBlock",
                            { id: q, dragPosition: Ze, mode: "insert" },
                            { schemaComponent: f },
                        ),
                    key: f,
                    linkProtocols: p,
            ...
            let F = "paragraph" in l;
            (Object.keys(l).forEach((q) => {
                let Ze = this.$refs[`floatingToolbar::${q}`];
                if (!Ze) {
                    ...
                    ja({
                        ...
                        shouldShow: ({ editor: Te }) =>
                            q === "paragraph"
                                ...
                                : F &&
                                    !Te.state.selection.empty &&
                                    Te.isActive("paragraph")
                                  ? !1
                                  : Te.isFocused && Te.isActive(q),
            ...
            let W = Alpine.debounce(() => {
                R || this.$wire.commit();
            }, m ?? 300);
            (V.on("update", ({ editor: q }) =>
                this.$nextTick(() => {
                    R ||
                        ((this.editorUpdatedAt = Date.now()),
                ...
                V.on("selectionUpdate", ({ transaction: q }) => {
                    R ||
                        ((this.editorUpdatedAt = Date.now()),
                        (this.editorSelection = q.selection.toJSON()));
                }),
                V.on("transaction", () => {
                    R || (this.editorUpdatedAt = Date.now());
                }),
                u &&
                    V.on("blur", () => {
                        R || this.$wire.commit();
                ...
                this.$watch("state", () => {
                    if (!R) {
                        ...
                        V.commands.setContent(this.state);
                    }
                }));
            let X = (q) => {
            ...
            (window.addEventListener("run-rich-editor-commands", X),
                _.push(["run-rich-editor-commands", X]));
            let oe = (q) => {
                q.detail.livewireId === g &&
                    q.detail.key === f &&
            ...
            (window.addEventListener("rich-editor-uploading-file", oe),
                _.push(["rich-editor-uploading-file", oe]));
            let Se = (q) => {
                q.detail.livewireId === g &&
                    q.detail.key === f &&
                    ((this.isUploadingFile = !1), q.stopPropagation());
            };
            (window.addEventListener("rich-editor-uploaded-file", Se),
                _.push(["rich-editor-uploaded-file", Se]));
            let Tt = (q) => {
                q.detail.livewireId === g &&
                    q.detail.key === f &&
            ...
            (window.addEventListener("rich-editor-file-validation-message", Tt),
                _.push(["rich-editor-file-validation-message", Tt]),
        ...
        setEditorSelection(F) {
            F &&
                ((this.editorSelection = F),
                V.chain()
                    .command(
                        ({ tr: W }) => (
                            W.setSelection(
                                kk.fromJSON(V.state.doc, this.editorSelection),
                            ),
                            !0
                        ),
                    )
        ...
        runEditorCommands({ commands: F, editorSelection: W }) {
            this.setEditorSelection(W);
            let X = V.chain();
            (F.forEach((oe) => (X = X[oe.name](...(oe.arguments ?? [])))),
                X.run());
        },
        togglePanel(F = null) {
            if (this.isPanelActive(F)) {
                this.activePanel = null;
                return;
            }
            this.activePanel = F;
        },
        isPanelActive(F = null) {
            return F === null
                ? this.activePanel !== null
                : this.activePanel === F;
        },
